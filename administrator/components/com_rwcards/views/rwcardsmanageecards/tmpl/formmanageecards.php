...
<div class="col100">
	<fieldset class="adminform">
		...
		?>
					...
					<td>
						<?php echo nl2br($row[$i]->description); ?>
					</td>
					<td>
						<?php echo $row[$i]->category_kategorien_name; ?>
					</td>
					...
					<td class="order">
						<span><?php echo $this->rwcards['_pageNav']->orderUpIcon( $i, ( $row[$i]->catid == @$rows[$i-1]->catid ), 'orderup', 'Move Up', $ordering ); ?></span>
						<span><?php echo $this->rwcards['_pageNav']->orderDownIcon( $i, $n, ( $row[$i]->catid == @$rows[$i+1]->catid ), 'orderdown', 'Move Down', $ordering ); ?></span>
