...
function pikniktubegetvideodetails($vidlink, $existingcode,$categorylist, $reqtype){
...
if ($reqtype=="new") {
		...
		$videoservertype="pikniktube";
		$smallvideocode=str_replace("http://www.pikniktube.com/video/","",$vidlink);

		//improved security not to call another site...

		$vidlink="http://www.pikniktube.com/video/".$smallvideocode;
	
} else if ($reqtype=="refresh") {
//http://www.pikniktube.com/v/1fe69e1cc9ba3d616769983220e54c4e/u/158839/e%FE%FEek_%FEakalar%FD
        ...
        $piknikurlmatch = "/(.*)";
        $smallvideocode  = eregi_replace($piknikurlmatch, '', $smallvideocode );

		$infolink="http://www.pikniktube.com/getxmle.asp?q=".$smallvideocode;
		...
		$pos = strpos($str, "\"image\"")+8;
		$trim1=substr($str,$pos,1800);
		$post = strpos($trim1, "</var>");
		$trim2=substr($trim1,0,$post);
		$picturelink=strip_tags($trim2);
...
function pikniktubeembed($vcode, $vthumb, $downloadcachingnotimeout, $downloadcachingtimeout, $pro, $catid, $setwidth=null, $setheight=null){
...
if ($pro=="1"){
	...
	$cachefile=$mosConfig_live_site."+pikniktube+".$vcode.$usevideoadsystem;	
	$md5cachefile=md5($cachefile).".xml";
	$fullmd5cachefile=$mosConfig_absolute_path."/seyretfiles/cache/pro/pikniktube/".$subdir.$md5cachefile;
	$fullmd5cachefilesite=$mosConfig_live_site."/seyretfiles/cache/pro/pikniktube/".$subdir.$md5cachefile;
...
if ($generatenewfile=="1"){
			...
			$dwnlink=pikniktubegeneratevideodownloadlink($vcode, $pro, "embed");
...
<image>".$vthumb."</image>
			...
			$makedir=$mosConfig_absolute_path."/seyretfiles/cache/pro/pikniktube";
			if (!is_dir($makedir))
					{
					$oldumask=umask(0);
					mkdir ($makedir,0755);
			...
			$makedir=$mosConfig_absolute_path."/seyretfiles/cache/pro/pikniktube/ad";
			if (!is_dir($makedir))
					{
					$oldumask=umask(0);
					mkdir ($makedir,0755);
...
$embedvideo="<object width=\"".$videowidth."\" height=\"".$videoheight."\" allowFullScreen=\"true\"><param name=\"flashvars\" value=\"linktarget=_blank&embedded=1&xmlsrc=http://www.pikniktube.com/getxmle.asp?q=".$vcode."&a=1&c=0\"></param><param name=\"movie\" value=\"http://www.pikniktube.com/player/videoplayer2.swf\"></param><param name=\"xmlsrc\" value=\"http://www.pikniktube.com/getxmle.asp?q=".$vcode."&a=1&c=0\"></param><embed src=\"http://www.pikniktube.com/player/videoplayer2.swf\" type=\"application/x-shockwave-flash\" allowFullScreen=\"true\" width=\"".$videowidth."\" height=\"".$videoheight."\" flashvars =\"linktarget=_blank&embedded=1&xmlsrc=http://www.pikniktube.com/getxmle.asp?q=".$vcode."&a=1&c=0\"></embed></object>";
...
function pikniktubegeneratevideodownloadlink($vcode, $pro, $dltask){
