<?php
//gofish.com plugin for Seyret component//
/**
* Content code
* @package SEYRET
...
function gofishcomgetvideodetails($vidlink, $existingcode,$categorylist, $reqtype){
...
if ($reqtype=="new") {
		...
		$smallvideocode=str_replace("http://www.gofish.com/player.gfp?gfid=","",$vidlink);
		$smallvideocode=str_replace("http://gofish.com/player.gfp?gfid=","",$smallvideocode);

		
		//improved security not to call another site...
		$videoservertype="gofish.com";

		$vidlink="http://www.gofish.com:80/getGFX2.gfp?gfid=".$smallvideocode;
	
} else if ($reqtype=="refresh") {
	if ($vidlink==""){
		$vidlink="http://www.gofish.com:80/getGFX2.gfp?gfid=".$existingcode;//trytoguess
	}	
...
function gofishcomembed($vcode, $vthumb, $downloadcachingnotimeout, $downloadcachingtimeout, $pro, $catid, $setwidth=null, $setheight=null){
...
if ($pro=="1"){
	...
	$cachefile=$mosConfig_live_site."+gofishcom+".$vcode.$usevideoadsystem;	
	$md5cachefile=md5($cachefile).".xml";
	$fullmd5cachefile=$mosConfig_absolute_path."/seyretfiles/cache/pro/gofishcom/".$subdir.$md5cachefile;
	$fullmd5cachefilesite=$mosConfig_live_site."/seyretfiles/cache/pro/gofishcom/".$subdir.$md5cachefile;
...
if ($generatenewfile=="1"){
			...
			$dwnlink=gofishcomgeneratevideodownloadlink($vcode, $pro, "embed");
...
<image>".$vthumb."</image>
			...
			$makedir=$mosConfig_absolute_path."/seyretfiles/cache/pro/gofishcom";
			if (!is_dir($makedir))
					{
					$oldumask=umask(0);
					mkdir ($makedir,0755);
			...
			$makedir=$mosConfig_absolute_path."/seyretfiles/cache/pro/gofishcom/ad";
			if (!is_dir($makedir))
					{
					$oldumask=umask(0);
					mkdir ($makedir,0755);
...
$embedvideo="<embed src=\"http://www.gofish.com/player/fwplayer.swf\" width=\"".$videowidth."\" height=\"".$videoheight."\" align=\"middle\" quality=\"high\" bgcolor=\"#000000\" name=\"fwplayer\" allowScriptAccess=\"sameDomain\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\" FlashVars=\"&loc=blog_blog&amp;gf=false&amp;ns=false&amp;fs=true&amp;gfid=".$vcode."&amp;c=grey&amp;autoPlay=false&amp;getAd=false&amp;wm=true&amp;ct=true&amp;tb=false\"></embed>";
}
...
function gofishcomgeneratevideodownloadlink($vcode, $pro, $dltask){
