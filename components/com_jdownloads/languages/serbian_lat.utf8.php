...
* 
* ======================
// Srpski prevod uradio Vasilj Milošević (::eboye::) 2008.09.20
...
DEFINE('_JLIST_INSTALL_4','Sačuvani podrazumevani izgledi u bazu!');
DEFINE('_JLIST_INSTALL_5','Sve podrazumevane licence postoje u bazi!');
DEFINE('_JLIST_INSTALL_6','Sačuvane podrazumevane licence u bazu!');
DEFINE('_JLIST_INSTALL_7','Direktorijum za upload postoji i moguć je upis!');
DEFINE('_JLIST_INSTALL_8','Direktorijum za upload postoji i NIJE moguć upis. Podesite CHMOD na 0777 za direktorijum za uplaod, u protivnom jDownloads neće raditi!');
DEFINE('_JLIST_INSTALL_9','Direktorijum za upload kreiran. CHMOD 0777 će biti postavljen.');
DEFINE('_JLIST_INSTALL_10','Greška: Direktorijum za upload nije moguće kreirati!<br />Kreirajte ga ručno preko FTPa i podesite CHMOD na 0777 za direktorijum za upload, u protivnom jDownloads neće raditi!');
DEFINE('_JLIST_INSTALL_11','Privremeni direktorijum za .zip postoji i moguć je upis!');
DEFINE('_JLIST_INSTALL_12','Direktorijum za upis /skidanje /privremenih zip fajlova postoji i NIJE moguć upis. Podesite CHMOD na 0777 za direktorijum za upload, u protivnom jDownloads neće raditi!');
DEFINE('_JLIST_INSTALL_13','Direktorijum za upis /skidanje /privremenih zip fajlova kreiran. Mogućnost upisa: CHMOD 0777 - OK.');
DEFINE('_JLIST_INSTALL_14','Greška: .zip direktorijum /skidanje/privremenih zip fajlova nije moguće kreirati!<br />Kreirajte ga ručno preko FTPa i podesite CHMOD na 0777 za direktorijum privremenih .zip fajlova.<br />u protivnom jDownloads neće raditi!!');
DEFINE('_JLIST_INSTALL_15','Instalacija uspešna!');
DEFINE('_JLIST_INSTALL_16','Pokreni jDownloads!');

DEFINE('_JLIST_INSTALL_DB_TIP','Info: Ako deinstalirate jDownloads baza neće biti obrisana. Ako kasnije budete koristili noviju verziju, baza će biti ponovo korišćena.');
DEFINE('_JLIST_INSTALL_TITLE_FOR_DEFAULT_LAYOUTS','Standard');

//FRONTEND

DEFINE('_JLIST_FILE_NOT_FOUND','Traženi fajl nije nađen. Molimo obavestite webmastera.');
DEFINE('_JLIST_LINKTEXT_VIEW_FILE_TYPES','Započni download<br />(prikaži u novom prozoru)');
DEFINE('_JLIST_LINKTEXT_ZIP','Započni download');
DEFINE('_JLIST_LINKTEXT_DOWNLOAD_URL','Download');
DEFINE('_JLIST_LINKTEXT_HOME','Početna strana');
...
DEFINE('_JLIST_FRONTEND_HOMEPAGE','Početna strana');
...
DEFINE('_JLIST_BACKEND_TOOLBAR_MAIN','Početna');
...
DEFINE('_JLIST_BACKEND_CPANEL_RESTORE','Vraćanje sigurnosne kopije');
DEFINE('_JLIST_BACKEND_CPANEL_INFO','Uslovi korišćenja');
...
DEFINE('_JLIST_BACKEND_AUTOCHECK_NEW_FILES','Nađeni novi fajlovi i dodati u download-bazu!');
DEFINE('_JLIST_BACKEND_AUTOCHECK_MISSING_FILES','Fajl(ovi) nisu nađeni. Fajlovi više nisu čitljivi za javnost!');
DEFINE('_JLIST_BACKEND_AUTOCHECK_NO_NEW_FILES','Nisu nađeni novi fajlovi!');
...
DEFINE('_JLIST_BACKEND_PANEL_STATUS_DESC_ONLINE','Ako je ONLINE, odeljak za download je čitljiv za posetioce.');
...
DEFINE('_JLIST_BACKEND_OFFLINE_OPTION_DESC','Sa ovom opcijom podešavate ceo odeljak za download na "isključeno". Posetiocima će biti prikazan tekst ispod. Samo korisnici sa statusom "author" su u mogućnosti da vide download odeljak.');
...
DEFINE('_JLIST_BACKEND_OFFLINE_MESSAGE_DESC','Ubacite tekst koji će biti prikazan ako je download odeljak još pod održavanjem.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_SAVED','Konfiguracija sačuvana');
...
DEFINE('_JLIST_BACKEND_SETTINGS_UPLOADDIR_DESC','Glavni direktorijum za upload fajlova. Ovaj direktorijum i <b>all</b> pod-direktorijumi moraju imati mogućnost upisa!');

DEFINE('_JLIST_BACKEND_SETTINGS_UPLOADDIRTEMP','Privremeni direktorijum');
DEFINE('_JLIST_BACKEND_SETTINGS_UPLOADDIRTEMP_DESC','Ovaj direktorijum mora postojati i imati mogućnost upisa! On sadrži privremeno kreirane .zip fajlove (posle downloada, automatski se brišu).');
...
DEFINE('_JLIST_BACKEND_SETTINGS_SEND_MAILTO_BETREFF_DESC','Tekst koji će se koristiti za subjekat e-mail-a.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_COMPO_TEXT_DESC','Tekst prikazan <b>između</b> naziva komponente i njenih kategorija. Naziv komponente se automatski preuzima iz imena u meniju.<br /><br />CSS klase, HTML kod i arbitarni tekst može biti uključen.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_VIEW_FILE_TYPES_DESC','Uključiti tipove fajlova, koji će biti otvoreni u novom prozoru. Između svake ekstenzije morate staviti ","');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_SHOW_MINIPICS_DESC','Ako je aktivirano, simboli će biti prikazani. Ako je isključeno, prikazuje se tekst.');

DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_MINIPICS_SIZE','Veličina u pikselima za informacioni simbol');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_MINIPICS_SIZE_DESC','Veličina prikaza za informacione simbole. Standard: 20');

DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_CATPICS_SIZE','Veličina u pikselima za simbol kategorije');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_CATPICS_SIZE_DESC','Veličina prikaza za simbol kategorije. Možete koristiti svoje ikone, samo uploadovanjem preko FTPa u pod-direktorijum: /catimages. Standard: 48');

DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_FILEPICS_SIZE','Veličina u pikselima za simbol fajla');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_FILEPICS_SIZE_DESC','Veličina prikaza za simbol fajlova. Možete koristiti svoje ikone, samo uploadovanjem preko FTPa u pod-direktorijum: /fileimages. Standard: 32');

// View backend security settings
// to be translated
DEFINE('_JLIST_BACKEND_SETTINGS_MAIL_SECURITY_DESC','Ako je namešteno na DA, e-mail adrese nisu prikazane u čistom tekstu da bi sprečili Spambotove. Upamtite da ako je isključena javascripta u vašem browser-u, link neće biti prikazan. Preporučeno podešavanje: DA.');
//
...
DEFINE('_JLIST_BACKEND_SETTINGS_EDITOR_LAYOUTS_DESC','Ako je ova opcija aktivirana, trenutno selektovan WYSIWYG editor se koristi za izmenu izgleda. Ako nije, običan text area se prikazuje.');
DEFINE('_JLIST_BACKEND_SETTINGS_EDITOR_FILES','Koristi WYSIWYG-editor za downloade');
DEFINE('_JLIST_BACKEND_SETTINGS_EDITOR_FILES_DESC','Ako je ova opcija aktivirana, trenutno selektovan WYSIWYG editor se koristi za izmenu downloada. Ako nije, običan text area se prikazuje.');
DEFINE('_JLIST_BACKEND_SETTINGS_EDITOR_CATS','Koristi WYSIWYG-editor za kategorije');
DEFINE('_JLIST_BACKEND_SETTINGS_EDITOR_CATS_DESC','Ako je ova opcija aktivirana, trenutno selektovan WYSIWYG editor se koristi za izmenu kategorija. Ako nije, običan text area se prikazuje.');
DEFINE('_JLIST_BACKEND_SETTINGS_EDITOR_LICENSES','Koristi WYSIWYG-editor za licence');
DEFINE('_JLIST_BACKEND_SETTINGS_EDITOR_LICENSES_DESC','Ako je ova opcija aktivirana, trenutno selektovan WYSIWYG editor se koristi za izmenu licenci. Ako nije, običan text area se prikazuje.');

DEFINE('_JLIST_BACKEND_SETTINGS_FILE_SYSTEM_LIST','Selektuj polja za download: edit "Sistem"');
DEFINE('_JLIST_BACKEND_SETTINGS_FILE_SYSTEM_LIST_DESC','Ovde možete menjati predložene opcije za polja. Između svake opcije potreban je "," razdelnik. <br /><br /><b>Važna naznaka:</b> ako već imate sačuvane download liste, budite pažljivi, jer svaka promena utiče na download-e. Primer: Ako su neki downloadi sačuvani pod sistemom "Joomla 1.5", biće podešeni na drugu vrednost npr. "Windows Vista". Dodajte nove vrednosti na kraj liste.');

DEFINE('_JLIST_BACKEND_SETTINGS_FILE_LANGUAGE_LIST','Selektuj polja za download: edit "Jezik"');
DEFINE('_JLIST_BACKEND_SETTINGS_FILE_LANGUAGE_LIST_DESC','Ovde možete menjati predložene opcije za polja. Između svake opcije potreban je "," razdelnik. <br /><br /><b>Važna naznaka:</b> ako već imate sačuvane download liste, budite pažljivi, jer svaka promena utiče na download-e. Primer: Ako su neki downloadi sačuvani pod jezikom ="Deutsch", biće podešeni na drugu vrednost npr. "French". Dodajte nove vrednosti na kraj liste.');

DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_ZIPFILE_PREFIX_TEXT','Podrazumevani prefiks za naziv ZIP fajlova');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_ZIPFILE_PREFIX_DESC','Ako je selektovano više fajlova za download, oni su automatski arhivirani u privremeni ZIP fajl i prezentovani korisniku kao jedan fajl za download. Ime ZIP fajla se dodeljuje od prefiksa i nasumičnog broja.');

// Templates Config Backend
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_HEAD','<b>Izgledi određuju način prikazivanja sadržaja u frontend-u</b>');
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_HEAD_INFO','<br />Nekoliko standardnih izgleda je sadržano pri instalaciji. Oni mogu biti prilagođeni po želji i novi izgledi mogu biti kreirani. Pojednostavljena konfiguracija vam omogućuje da putem WYSIWYG editora ili običnog text area za editovanje, menjate izglede.<br /><br />U slučaju da frontend komponente ne funkcioniše ispravno posle izmena <b>podrazumevanih izgleda originalnog sadržaja</b> (misli se na stanje posle instalacije) može se uvek vratiti na početnu vrednost. Da bi ste to uradili, obrišite <b>sav tekst</b> u respektivnom izgledu i <b>sačuvajte</b>. Stranica će biti sačuvana sa originalnim sadržajem. <b>Pažnja:</b> promene napravljene će biti izgubljene.<br /><br />Napomena: nekoliko promenljivih je korišćeno u izgledu (npr. <font color=darkred>{files}</font>). Promenljive će biti zamenjene sa stvarnim sadržajem kada se generišu na sajtu.<br />');

DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_CATS','Izgled: Kategorije');
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_CATS_DESC','Ovo je primer kako se <b>kategorije</b> prikazuju u frontendu. Ako ste selektovali opciju <b>Prikaži početnu stranicu sa pregledom kategorija</b> u globalnim konfiguracijama, {files} i {checkbox_top} promenljive su samo za prikazivanje jedne kategorije.<br /><br /><font color=red>{files} {form_hidden} {form_button} {checkbox_top}</font> promenljive <font color=red>NE</font> bi trebale biti uklonjene iz koda! Obrišite samo promenljive {checkbox_top} iz koda ako je promenljiva {url_download} korišćena u izgledu fajla. {files} tag je zamenjen sa podacima iz izgleda fajla. <br /><br />Dostupne promenljive (variables):<br />{cat_title} {cat_description} {cat_pic} {files} {checkbox_top} {sum_subcats} {sum_files_cat}');
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_CATS_INFO_TITLE','<b>Informacije o izgledu kategorije:</b>');
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_CATS_INFO_TEXT','<p>Ovo je grafički primer frontenda opisa kategorije. Tamno crvena ivica ukazuje polje kojem ovde možete menjati vrednosti.</p>');
...
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_FILES_INFO_TEXT','<p>Primer za prikazivanje liste u frontendu. Unutar crvenog pravougaonika možete menjati način prikazivanja.</p>');
...
DEFINE('_JLIST_BACKEND_CATSLIST_READ','Čitaj');
...
DEFINE('_JLIST_BACKEND_CATS_SAVEORDER','Novi redosled sačuvan');
...
DEFINE('_JLIST_BACKEND_CATSEDIT_CAT_ACCESS_DESC','Izmeni prava. Definišite korisnička prava za kategorije, poddirektorijume i uključene downloade. <b>Presudna za pristup je UVEK superiorna kategorija.</b> Ako selektujete "specijalni", korisnici sa "autor" statusom će moći da vide i skidaju.');
DEFINE('_JLIST_BACKEND_CATSEDIT_CAT_ACCESS_LEVEL_1','Javno čitanje i  download');
DEFINE('_JLIST_BACKEND_CATSEDIT_CAT_ACCESS_LEVEL_2','Javni i registrovani korisnici mogu da čitaju i skidaju');
DEFINE('_JLIST_BACKEND_CATSEDIT_CAT_ACCESS_LEVEL_3','Samo registrovani korisnici mogu da čitaju i skidaju');
DEFINE('_JLIST_BACKEND_CATSEDIT_CAT_ACCESS_LEVEL_4','Samo specijalni korisnici mogu da čitaju i skidaju');

//BACKEND FILESLIST
DEFINE('_JLIST_BACKEND_FILESLIST_TITLE','Downloadi');
DEFINE('_JLIST_BACKEND_FILESLIST_SEARCH','Pretraga');
DEFINE('_JLIST_BACKEND_FILESLIST_SEARCH_LIMIT','Ograničenja');
...
DEFINE('_JLIST_BACKEND_FILES_SAVEORDER','Novi redosled sačuvan');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_SAVE','Download sačuvan.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_CHECK_PERMISSIONS','Fajl nije moguće postaviti. Proverite prava na vašem serveru (FTP: namestite na CHMOD 0777)');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_SIZE','Veličina');
DEFINE('_JLIST_BACKEND_FILESEDIT_SIZE_DESC','Ako nije izabrano, veličina će biti postavljena automatski');
DEFINE('_JLIST_BACKEND_FILESEDIT_DADDED','Datum i vreme');
DEFINE('_JLIST_BACKEND_FILESEDIT_DADDED_DESC','Definišite datum u sledećem formatu: <b>YYYY-MM-DD H:mm:ss</b> ili koristite kalendar. Ako je ostavljeno prazno trenutni datum-vreme se koristi automatski');
DEFINE('_JLIST_BACKEND_FILESEDIT_FILE','Selektuj fajl za upload');
DEFINE('_JLIST_BACKEND_FILESEDIT_FILE_DESC','U ovom polju možete dodeliti ime fajla za postavljen dajl na server. Ovo ime će biti korišćeno za skidanje.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_URL_HOME','Sajt (bez http:// na početku)');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_AUTHOR_URL_DESC','e-mail adrese će biti automatski enkriptovane.');
DEFINE('_JLIST_BACKEND_FILESEDIT_URL_DOWNLOAD','KORENI direktorijum za postavljanje');
DEFINE('_JLIST_BACKEND_FILESEDIT_URL_DOWNLOAD_WRITABLE','Status: <font color=green><strong>UPIS MOGUĆ</strong></font>');
DEFINE('_JLIST_BACKEND_FILESEDIT_URL_DOWNLOAD_NOTWRITABLE','Status: <font color=red><strong>UPIS NIJE MOGUĆ</strong></font>');

DEFINE('_JLIST_BACKEND_FILESEDIT_URL_TEMP_WRITABLE','Status: <font color=green><strong>UPIS MOGUĆ</strong></font>');
DEFINE('_JLIST_BACKEND_FILESEDIT_URL_TEMP_NOTWRITABLE','Status: <font color=red><strong>UPIS NIJE MOGUĆ</strong></font>');
...
DEFINE('_JLIST_BACKEND_LICEDIT_SAVE','Licenca sačuvana.');
...
DEFINE('_JLIST_BACKEND_TEMPEDIT_SAVE','Izgled sačuvan.');
...
DEFINE('_JLIST_BACKEND_TEMPEDIT_TYP_DESCRIPTION','Selektujte odgovarajuć tip izgleda.');
...
DEFINE('_JLIST_BACKEND_RESTORE_TITLE_HEAD','Vraćanje sigurnosne kopije');
...
DEFINE('_JLIST_BACKEND_RESTORE_RUN_FINAL','Započni vraćanje?');
DEFINE('_JLIST_BACKEND_RESTORE_WARNING','Za vreme vraćanja, trenutna baza će biti zamenjena sigurnosnom.<br /><br />NEMA garancije da će sigurnosna kopija raditi bez problema. Za dodavanje sigurnosti, preporučljivo je napraviti sigurnosnu kopiju preko FTP klijenta. Ako nova jdownloads verzija preuzima trenutnu bazu, jdownloads vraćanje će pokušati da prilagodi novoj strukturi kategorija. Molimo sačekajte da se vraćanje sigurnosne kopije završi pre odlaska sa stranice. u slučaju velike strukture kategorije i fajlova, proces vraćanja može potrajati nekoliko minuta. Informacije o procesu vraćanja mogu se naći u "Restore Log"');
DEFINE('_JLIST_BACKEND_RESTORE_MSG','%s Vraćanje sigurnosne kopije je uspešno završeno.');
DEFINE('_JLIST_BACKEND_RESTORE_MSG_2','Pogledajte informacije o vraćanju u logu: "Restore Log".');
...
DEFINE('_JLIST_BACKEND_EDIT_CSS_SAVED','CSS-fajl sačuvan');
DEFINE('_JLIST_BACKEND_EDIT_LANG_SAVED','Fajl za jezik sačuvan');
...
DEFINE('_JLIST_BACKEND_EDIT_LANG_CSS_FILE_WRITABLE_INFO','Fajl mora biti upisiv da bi sačuvali nova podešavanja. Možda morate promeniti prava na fajl na CHMOD 0777.');
...
DEFINE('_JLIST_SETTINGS_LICENSE4_TEXT','Linkware se zahteva da autorovom sajtu za vreme korišćenja software-a.');
DEFINE('_JLIST_SETTINGS_LICENSE4_URL','');

DEFINE('_JLIST_SETTINGS_LICENSE5_TITLE','Charityware');
DEFINE('_JLIST_SETTINGS_LICENSE5_TEXT','Charityware dozvoljava slobodno korišćenje, autor traži donacije za dobar razlog.');
...
DEFINE('_JLIST_INSTALL_1_2','Podaci već postoje u bazi!');
DEFINE('_JLIST_INSTALL_2_2','Data was altered, added or non existent (translation or context to be checked!)!');
DEFINE('_JLIST_INSTALL_17','Instalacija JoomFish-a nađena! jDownloads JoomFish definicije dodate:');
//------------------------------------------
...
//FRONTEND UPLOAD
DEFINE('_JLIST_FRONTEND_UPLOAD_ACCESS_ONLY_REGGED','Morate biti registrovan korisnik da bi poslali fajlove. Ako ste već registrovani na ovom sajtu, molimo va ulogujte se. ');
DEFINE('_JLIST_FRONTEND_UPLOAD_ACCESS_ONLY_SPECIALS','Nemate ovlašćenja da postavite fajlove.');
...
DEFINE('_JLIST_FRONTEND_UPLOAD_ALLOWED_MAX_SIZE','Dozvoljena maksimalna veličina');
...
DEFINE('_JLIST_FRONTEND_UPLOAD_ERROR_FILESIZE','Greška: veličina odabranog fajla je veća od dozvoljene maksimalne veličine!');
...
// AUTOCHECK DOWNLOADS
DEFINE('_JLIST_BACKEND_AUTOCHECK_NEW_CATS','novi direktorijumi su nađeni i dodati kao kategorije!!');
DEFINE('_JLIST_BACKEND_AUTOCHECK_MISSING_CATS','Direktorijum kategorija nisu više nađeni, tako da odgovarajuće kategorije neće biti objavljene!');
DEFINE('_JLIST_BACKEND_AUTOCHECK_NO_NEW_CATS','Nisu nađeni novi direktorijumi!');
...
DEFINE('_JLIST_BACKEND_AUTOCHECK_LOG_TAB_TITLE','Poslednja interna poruka (akcije) za vreme Downloada praćene'); 
DEFINE('_JLIST_BACKEND_AUTOCHECK_REFRESH_MESSAGE','Morate osvežiti stranicu da bi ste videli izmene!'); 

DEFINE('_JLIST_BACKEND_RESTORE_LOG_TAB_TITLE','Rezultati poslednjeg vraćanja sigurnosne kopije'); 

DEFINE('_JLIST_BACKEND_PANEL_STATUS_DESC_OFFLINE','Mod za izmene je aktiviran! Odeljak za download nije dostupan trenutno za normalne korisnike! Takođe nije dostupna ni za članove koji pripadaju "Autor" grupi.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_DEL_TEMPFILE_TIME_DESC','Naznačite vrednost u minutama, posle kog se privremeno kreirani Zip fajlovi za višestruki download brišu sa servera. Ako nudite velike fajlove, onda bi trebali da stavite veću vrednost. Podrazumevana vrednost je 20 minuta.');

DEFINE('_JLIST_BACKEND_SETTINGS_GLOBAL_FRONTEND_HEAD_UPLOAD','Konfiguracija Frontend Uploada');
DEFINE('_JLIST_BACKEND_SETTINGS_UPLOADDIR_RENAME_ERROR','Greška: Koreni direktorijum za download nije moguće preimenovati!');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_FILES_PER_SIDE_DESC','Podesite broj kategorija/downloada koji će biti prikazan na stranici u front-end-u.');

DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_HEADER_TITLE','Naziv koji će biti korišćen za header');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_HEADER_DESC','Definišite ovde naziv koji će biti prikazivan u front-end-u kao naziv komponente, npr.. "Downloads".');

// FRONTEND UPLOAD CONFIG
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_ACTIVE','Frontend Upload aktivacija:');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_ACTIVE_DESC','Ako je aktivirano, korisničke grupe definisane ispod mogu postavljati fajlove preko formulara.');

DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_PERMISSIONS','Ko može da postavlja fajlove:');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_PERMISSIONS_DESC','Ovde definišete koje grupe korisnika mogu da postavljaju fajlove. "Specijalni" postavka omogućuje članovima sa statusom >= "author" da pristupe formularu za postavljanje.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FILETYPES_DESC','Definišite individualne ekstenzije koje mogu biti postavljene sa formularom za postavljanje. Između svake stavke mora stajati zarez (,).');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FILESIZE','Maksimalna veličina u KB:');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FILESIZE_DESC','Definišite ovde maksimalnu dozvoljenu veličinu za postavljanje fajlova u kilobajtima (1024 Kb = 1 Mb). Podrazumevana vrednost: 2048.');

DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FORM_TEXT','Tekst za formular za postavljanje:');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FORM_TEXT_DESC','Ovde definišete izgled za upload formular (ispred ili iza teksta). Promenljiva: {form} će biti zamenjena sa stvarnim formularom u frontend izlazu. Simbol promenljive ne može biti obrisan!');

// Platzhalter {form} NICHT ÄNDERN ODER LÖSCHEN !!!
// DO NOT DELETE, EDIT OR TRANSLATE: {form} !!! 

DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FORM_TEXT_LAYOUT','Ovaj formular omogućuje postavljanje fajla na server. Sva polja sa simbolima su obavezna. Vaše ime ili e-mail adresa neće nikad biti odana trećem licu i služi samo za internu upotrebu.<br />
{form}<br />');

DEFINE('_JLIST_BACKEND_TEMPLIST_DEL_QUEST','Obriši izgled(e)?');
DEFINE('_JLIST_BACKEND_LICLIST_DEL_QUEST','Obriši Licencu(e)?');

DEFINE('_JLIST_BACKEND_FILESEDIT_URL_DOWNLOAD_STATUS_DESC','Ovde vidite konfiguracioni status za KORENI direktorijum za upload. Ako nije moguć upis, molimo vas da proverite pristupna prava sa FTP programom. Prava bi trebala da budu na CHMOD 0777.');

DEFINE('_JLIST_BACKEND_FILESEDIT_HITS','Broj prošlih Downloada');
DEFINE('_JLIST_BACKEND_FILESEDIT_HITS_DESC','Ovde Download brojač može biti promenjen ili anuliran');

DEFINE('_JLIST_BACKEND_FILESEDIT_FILE_CAT_DESC','Morate dodeliti Download kategoriji. Selektujte iz liste odgovarajuću kategoriju. Ako kasnije selektujete drugu kategoriju, onda će fajlovi biti automatski premešteni u direktorijum nove kategorije.');

DEFINE('_JLIST_BACKEND_FILESEDIT_DESCRIPTION_KURZ','Kratak opis');
DEFINE('_JLIST_BACKEND_FILESEDIT_DESCRIPTION_LONG','Dugačak opis');
DEFINE('_JLIST_BACKEND_FILESEDIT_EDITOR_INFO','U formularu za konfiguraciju može biti namešteno da li je aktiviran WYSIWYG editor ili obično polje za tekst za izmene.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_SAVE_MOVEFILE_ERROR',' - Greška: Fajl nije moguće premestiti!');
...
DEFINE('_JLIST_BACKEND_FILESLIST_DEL_FILES_OPTION_TOOLTIP','Ako DA, fajlovi ne brišu se samo fajlovi nego i fajlovi sa servera! Ako fajl nije obrisan a pritom monitoring uključen, onda je fajl automatski smatran kao nova stavka!<br /><b>Preporučeno podešavanje: DA</b >.');
DEFINE('_JLIST_BACKEND_FILESEDIT_DEL_FILES_OK',' - Vezani fajlovi se takođe brišu.');
...
DEFINE('_JLIST_BACKEND_CATSEDIT_CAT_LISTBOX_DESC_NEW','Ako se nova kategorija kreira, onda selektujte "Glavna kategorija". Ako nova kategorija treba da bude podkategorija postojeće kategorije, onda odaberite postojeću kategoriju kao nadkategoriju. Nova kategorija će biti kreirana ispod. Hijerarhija može biti menjana kasnije.');
...
Prilikom čuvanja, trenutna kategorija se odmah prebacuje na serveru. Ako prebačena kategorija sadrži podkategorije, one su takođe premeštene. Da bi bili sigurni sa internim operacijama, SVE kategorije koje se trenutno menjaju su zakljčane dok se ova operacija izvršava!');
DEFINE('_JLIST_BACKEND_CATSEDIT_SAVE','Kategorija sačuvana.');
...
// BACKEND CATS DELETE
DEFINE('_JLIST_BE_NO_DEL_SUBCATS_EXISTS','Kategoriju nije moguće obrisati jer sadrži podkategorije!');
DEFINE('_JLIST_BE_NO_DEL_FILES_EXISTS','Kategoriju nije moguće obrisati jer sadrži fajlove!');
DEFINE('_JLIST_BE_DEL_CATS_DIRS_OK',' - Direktorijum uspešno obrisan!');
DEFINE('_JLIST_BE_DEL_CATS_DIRS_ERROR',' - Gređka prilikom brisanja!');
...
DEFINE('_JLIST_UPLOAD_MAX_FILESIZE_INFO_TITLE','Maksimalna veličina kao definisana u konfiguracionom php.ini fajlu:');

DEFINE('_JLIST_BACKEND_TEMPLATE_ACTIVE_ERROR','Samo JEDAN izgled može biti selektovan za aktivaciju!');
DEFINE('_JLIST_AUTO_FILE_CHECK_IMPORT_BY','Automatsko uključivanje');          
DEFINE('_JLIST_AUTO_FILE_CHECK_ADDED',   'Fajl dodat    ');
DEFINE('_JLIST_AUTO_FILE_CHECK_DISABLED','Fajl nije nađen      ');
DEFINE('_JLIST_AUTO_CAT_CHECK_ADDED',    'Kategorija dodata');
DEFINE('_JLIST_AUTO_CAT_CHECK_DISABLED', 'Kategorija nije nađena  ');
...
DEFINE('_JLIST_CHECK_CATS_TITEL2','Kao posledica, sve kategorije i fajlovi već kreirani moraju biti transferovani u novu strukturu kategorija!');          
...
DEFINE('_JLIST_CHECK_FILES_NOT_FOUND','Fajlovi nisu nađeni!');
...
DEFINE('_JLIST_AFTER_RESTORE_TITLE_1','Proces vraćanja aktivan:');
DEFINE('_JLIST_AFTER_RESTORE_1','Sadrćaj vraćen!');
DEFINE('_JLIST_AFTER_RESTORE_TITLE_2','Proces provere baze započet:');
...
DEFINE('_JLIST_AUTOCHECK_DIR_NOT_EXIST_2','Molimo vas da napravite dva direktorijuma /downloads i /downloads/tempzipfiles u vašem Joomla korenom direktorijumu preko ftp programa i podesite pristupna prava na CHMOD 0777 - u suprotnom jDownloads neće raditi!');
...
DEFINE('_JLIST_FRONTEND_SEARCH_TEXT_TITLE','Traži sledeće');
...
DEFINE('_JLIST_FRONTEND_SEARCH_RESULT_SUM_FILES','nađeno');
DEFINE('_JLIST_FRONTEND_SEARCH_RESULT_NO_SUM_FILES','Nijedan fajl nije nađen kao rezultat pretrage.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_DETAILS_INFO_TEXT','<p>Grafički primer stranice u frontendu. Tamno crvena ivica ukazuje na polje koje možete da menjate ovde.</p>');
...
DEFINE('_JLIST_FE_DETAILS_FILESIZE_TITLE','Veličina');
...
DEFINE('_JLIST_BACKEND_TEMPEDIT_CHECKBOX_DESC','Ako da, CHECK box naslovna linija i dugme za nastavak se prikazuju. Dodatna promenljiva <b>{checkbox_list}</b> mora biti ubačena u izgled. Ako ne, promenljiva <b>{url_download}</b>mora biti ubačena u izgled.'); 
DEFINE('_JLIST_BACKEND_TEMPEDIT_SYMBOLE_TITLE','Ubaci mini-simbol?');
DEFINE('_JLIST_BACKEND_TEMPEDIT_SYMBOLE_DESC','Ako da, mini-simbol će biti ubačen. Veličina simbola može biti podešena u konfiguracionom delu.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_INFO_FIELDS_DESC','Kutijice levo, daju informacije: ime izdavača, poslednjeg editora, poslednje vreme izmene');

DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_CATLISTBOX_ACTIVE','Prikaži listu kategorija u zaglavlju?');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_CATLISTBOX_DESC','Ako DA, lista sa svim objavljenim kategorijama za korisnike prema njihovim pravima  se prikazuju na desnoj strani zaglavlja. Iz ove liste je moguće direktno pristupati Kategoriji/Podkategoriji.');
...
DEFINE('_JLIST_SAMPLE_DATA_EXISTS','Primeri već postoje!');
DEFINE('_JLIST_SAMPLE_DATA_BACK_TO_PANEL','Vrati se na kontrolni panel');


DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_HEAD_INFO2','<br /><b><u>Objašnjenje izgleda</u></b><br /><b>Kategorije: </b>Definiše izgled kategorija kao i fajlova za korišćenje CHECK box-a iznad i ispod download liste.<br /><b>Fajlovi: </b>Definiše izgled Download liste prikazane ispod kategorija.<br /><b>Detalji Download-a: </b>Definiše izgled Detaljnog prikaza download-a.<br /><b>Suma: </b>Definiše izgled sumirane stranice (sa koje se započinje download) sa listom selektovanih fajlova za download.<br /><b>e-mails: </b>Definiše izgled e-mail-a koji se šalje administratoru posle svakog download-a.');

// ANTI_LEECH_CONFIG
DEFINE('_JLIST_BACKEND_SETTINGS_ANTILEECH_TITLE','Zaštita vašeg Download-direktorijuma?');
DEFINE('_JLIST_BACKEND_SETTINGS_ANTILEECH_DESK','Ako DA, htaccess.txt će biti kopiran u vaš koreni download direktorijum i biti preimenovan u .htaccess. Zaštita će biti aktivirana i svaki spoljni pristup blokiran uključujući i poddirektorijume. <b><Preporučeno: DA!</b>');
...
DEFINE('_JLIST_FRONTEND_ANTILEECH_MESSAGE','Neovlašćen pristup fajlovima!');
DEFINE('_JLIST_FRONTEND_FILE_NOT_FOUND_MESSAGE','Traženi fajl nije nađen!<br /><br />Molimo da obavestite Webmaster-a!');

DEFINE('_JLIST_FRONTEND_SUMMARY_ZIP_FILESIZE','Veličina paketa za download');
...
DEFINE('_JLIST_BACKEND_SETTINGS_DIRECT_DOWNLOAD_ACTIVE_DESC','Ako DA: prilikom korišćenja promenljive <b>{url_download}</b> u izgledu, download se odmah započinje, bez prikaza sume.');

// NEW OPTION FOR HOT AND NEW IMAGES IN DOWNLOADS
DEFINE('_JLIST_BACKEND_SETTINGS_HOT_TITLE','Na kojoj tački je download validan kao "popularan"');
DEFINE('_JLIST_BACKEND_SETTINGS_HOT_DESC','Definišite broj skidanja posle kojeg je fajl označen sa "HOT". Iza naziva fajla "HOT" simbol će biti prikazan.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_NEW_DESC','Definišite broj dana, koliko je fajl validan kao "NEW". Iza naziva fajla "NEW" simbol će biti prikazan.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_DETAILS_DOWNLOAD_BUTTON_DESC','Fajl mora biti u direktorijumu <b>../components/com_jdownloads/images</b> i biće korišćen u detaljima kao link za skidanje.');

// NEW IN 1.2 beta 2
DEFINE('_JLIST_FRONTEND_UPLOAD_AUTO_PUBLISH','Fajlovi se automatski objavljuju:');
DEFINE('_JLIST_FRONTEND_UPLOAD_AUTO_PUBLISH_DESC','Ako DA, fajlovi će biti objavljeni odmah posle upload-a.');

// NEW IN 1.2 stable
DEFINE('_JLIST_BACKEND_DIRSEDIT_CREATE_DIR_MESSAGE_ERROR','Greška: Direktorijum nije moguće kreirati! Proverite preko FTPa da je CHMOD postavljen na 0777 za sve jDownloads direktorijume!');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FAUTO_ONLY_THIS_FILES_TITLE','Monitoring samo sledećih tipova fajlova:');
...
DEFINE('_JLIST_BACKEND_FILES_COPY_TEXT_1','Ovi fajlovi su označeni za kopiranje:');
...
DEFINE('_JLIST_BACKEND_FILES_COPY_TEXT_4','Takođe kopiraj fajlove:');
...
DEFINE('_JLIST_BACKEND_SETTINGS_JCOMMENTS_DESC','Da, aktiviraj funkciju komentara iz <b>JComments</b> u frontendu.<br /><b>JComments</b> nije uključen u jDownloads i morate ga instalirati i konfigurisati posebno.<br />Možete skinuti JComments ekstenziju sa <a href="http://www.joomlatune.com">www.joomlatune.com.</a>');
DEFINE('_JLIST_BACKEND_SETTINGS_JCOMMENTS_EXISTS_DESC','Da, prikaži funkciju JComments u detaljnom prikazu za fajlove<br /><b>JComments je već instaliran!</b>');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_NOT_INSTALLED','Dodatak mos_jdownloads_file može biti korišćen da prikaže fajlove jDownload u člancima i nije sastavni deo jDownloads i mora biti instaliran posebno. <br /><b>Status: Dodatak još uvek nije instaliran!</b><br />Možete naći dodatke na <a href="http://demo.joomlaaddons.de/index.php?option=com_jdownloads&Itemid=69&task=viewcategory&catid=9">www.JoomlaAddons.de</a>.');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_ONLINEPART','Parametri za aktiviranje dodatka');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_OFFLINEPART','Parametri za isključene dodatke');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_SHOWNEW','Prikaži simbol NEW');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_SHOWNEW_DESC','Prikaži (ili ne) simbol NEW u člancima.');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_SHOWHOT','Prikaži HOT-simbol');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_SHOWHOT_DESC','Prikaži (ili ne) HOT-simbol u člancima.');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_ENABLEPLUGIN','Aktiviraj dodatak');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_ENABLEPLUGIN_DESC','Aktiviraj dodatak. Ovo nije isti parametar kao parametar za objavljivanje u Joomla-i (publish). Ako isključite dodatak ovde, možete da obavestite posetioca o ovome. (Pogledaj parametre ispod)!');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_SHOWDISABLED','Prikaži poruku u slučaju isključenog dodatka');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_SHOWDISABLED_DESC','Kada isključite dodatak, možete prikazati poruku za mesto skidanja. Pogledaj parametre ispod.<br \><b>Ne</b>: Da ne prikaže ništa.<br \><b>Podrazumevani izgled</b>: Prikazuje poruku koristeći podrazumevani izgled (vidi gore).<br \><b>Offline izgled</b>: Prikazuje poruku koristeći offline izgled (pogledaj ispod).');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_OFFLINETITLE_DESC','Naziv za prikazivanje kada je dodatak isključen (zavisi od vaše selekcije iznad).');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_OFFLINEDESC','Opis zamene');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_OFFLINEDESC_DESC','Kada je dodatak isključen, ovaj opis se prikazuje na mestu originalnog opisa.');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_SPECIALLAYOUT','Offline izgled (kada je dodatak isključen)');
DEFINE('_JLIST_BACKEND_SETTINGS_FILEPLUGIN_SPECIALLAYOUT_DESC','Koristi ovaj izgled za prikazivanje offline-poruke kada je dodatak isključen.');
...
DEFINE('_JLIST_FRONTEND_SETTINGS_FILEPLUGIN_OFFLINE_FILETITLE','Download je isključen.');
...
DEFINE('_JLIST_FRONTEND_SETTINGS_FILEPLUGIN_FILEUNKNOWN','Nije moguće naći fajl! ID=<b>{fileid}</b>');
DEFINE('_JLIST_FRONTEND_SETTINGS_FILEPLUGIN_LAYOUTUNKNOWN','Nije moguće naći izgled <b>{thelayout}</b>!');
...
DEFINE('_JLIST_BACKEND_SETTINGS_DEFAULT_CAT_PIC_DESC','Ovde je moguće selektovati simbol, koji je odmah dodeljen novoj kategoriji. Naznačeno je u veličini gore.');

// NEW OPTIONS FOR DEFAULT FILE ICON
DEFINE('_JLIST_BACKEND_SETTINGS_DEFAULT_FILE_PIC_TITLE','Podrazumevana slika za fajlove:');
DEFINE('_JLIST_BACKEND_SETTINGS_DEFAULT_FILE_PIC_DESC','Ovde možete izabrati simbol, koji je automatski dodeljen novim fajlovima. Naznačeno je u veličini gore.');

// FOR MISSING NEW MINIPICS
DEFINE('_JLIST_FRONTEND_MINI_ICON_ALT_PRICE','Cena');
DEFINE('_JLIST_FRONTEND_MINI_ICON_ALT_FILESIZE','Veličina');
...
DEFINE('_JLIST_FRONTEND_EXTERN_FILE_USER_INFO','Ovaj fajl mora biti skidan posebno, pošto se nalazi na drugom serveru. Tako da ne može biti uključen u grupni download.');
