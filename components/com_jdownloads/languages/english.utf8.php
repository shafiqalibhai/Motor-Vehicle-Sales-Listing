...
DEFINE('_JLIST_BACKEND_FILESEDIT_MIRROR_URL_DESC','Here you can set a <u>further</u> mirror server for the download.<br />In the activated Layouts for Files and/or Download-Details you have to fill in the placeholders  {mirror_1} {mirror_2}.'); // changed in 1.4 beta
...
DEFINE('_JLIST_FRONTEND_EXTERN_FILE_USER_INFO','This file needs to be downloaded separately, as it is located on another server. Therefore this file cannot be included in a grouped download.');
