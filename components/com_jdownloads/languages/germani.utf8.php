...
DEFINE('_JLIST_VERSION','<br /><br />Bitte melde Fehler im Support-Forum auf <a href="http://www.JoomlaAddons.de">www.JoomlaAddons.de</a>.');
...
DEFINE('_JLIST_INSTALL_8','Das Upload Verzeichnis /downloads existiert bereits, aber es ist nicht beschreibbar. Setze die Schreibrechte mit einem FTP-Programm auf CHMOD 0777, andernfalls wird JDownloads nicht einwandfrei funktionieren!');
DEFINE('_JLIST_INSTALL_9','Verzeichnis /downloads wurde erstellt. Schreibzugriff wurde gesetzt: CHMOD 0777');
DEFINE('_JLIST_INSTALL_10','Fehler: Upload Verzeichnis /downloads konnte nicht erstellt werden!<br />Erstelle dieses Verzeichnis per FTP und setze die Zugriffsrechte<br />auf CHMOD 0777 - andernfalls wird jDownloads nicht einwandfrei funktionieren!');
...
DEFINE('_JLIST_INSTALL_12','Das Upload Verzeichnis /downloads/tempzipfiles existiert bereits aber es ist nicht beschreibbar. Setze die Schreibrechte mit einem FTP-Programm auf CHMOD 0777, andernfalls wird jDownloads nicht einwandfrei funktionieren!');
DEFINE('_JLIST_INSTALL_13','Verzeichnis /downloads/tempzipfiles wurde erstellt. Schreibzugriff wurde gesetzt: CHMOD 0777');
DEFINE('_JLIST_INSTALL_14','Fehler: Zip-Verzeichnis /downloads/tempzipfiles konnte nicht erstellt werden!<br />Erstelle dieses Verzeichnis per FTP und setze die Zugriffsrechte<br />auf CHMOD 0777 - andernfalls wird jDownloads nicht einwandfrei funktionieren!');
...
DEFINE('_JLIST_FILE_NOT_FOUND','Die angeforderte Datei wurde leider nicht gefunden. Bitte kontaktiere den Betreiber dieser Webseite und informiere Ihn darüber.');
...
DEFINE('_JLIST_FRONTEND_CAT_ACCESS_REGGED','Diese Kategorie erfordert eine Registrierung um Daten downloaden zu können.<br />Solltest du bereits registriert sein, so melde dich  bitte an.<br /><br />');
...
<h3>Zur Zeit finden Wartungsarbeiten im Downloadbereich statt.<br /><br />Bitte versuche es in einigen Minuten noch einmal.</h3><br /><img src="components/com_jdownloads/images/offline.png" />
</td></tr></table>');
DEFINE('_JLIST_BACKEND_OFFLINE_MESSAGE_DESC','Gebe hier den Text ein, der Besuchern des Downloadbereiches im Wartungsmodus angezeigt werden soll.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_DATETIME_DESC','Stelle hier ein, wie das Datum der Download-Dateien angezeigt werden soll. Infos zum Format findest du hier: <a href="http://www.php.net/manual/de/function.strftime.php" target="_blank">www.php.net</a>');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_COMPO_TEXT_DESC','Optionaler Text der <b>zwischen</b> Komponententitel und den Kategorien angezeigt wird. Den Komponententitel kannst du ebenfalls in der Konfiguration festlegen.<br /><br />Es können CSS-Klassen, HTML-Code sowie beliebiger Text eingefügt werden.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_SORTFILESORDER_TEXT','Sortierreihenfolge');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_SORTFILESORDER_DESC','Sortierreihenfolge der Dateien bei der Darstellung im Frontend. Wenn die im Backend standardmäßig vorgenommene Sortierung verwendet werden soll, so wähle: "Standard".');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_CATPICS_SIZE_DESC','Grösse in der die Kategorie Symbole angezeigt werden sollen. Es können auch eigene Symbole verwendet werden, lade hierzu einfach die Symbole über ein FTP-Programm in das Unterverzeichnis: /catimages. Die Symbole stehen dann automatisch zur Auswahl. Standard: 48');

DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_FILEPICS_SIZE','Grösse der Datei Symbole in Pixel');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_FILEPICS_SIZE_DESC','Grösse in der die Datei Symbole angezeigt werden sollen. Es können auch eigene Symbole verwendet werden, lade hierzu einfach die Symbole über ein FTP-Programm in das Unterverzeichnis: /fileimages. Die Symbole stehen dann automatisch zur Auswahl. Standard: 32');

// View backend security settings
DEFINE('_JLIST_BACKEND_SETTINGS_MAIL_SECURITY_DESC','Wenn JA, werden die E-Mail Adressen nicht im Klartext angezeigt um das auslesen durch Spambots zu erschweren. Beachte, dass Besucher, welche die Javascript-Option in ihrem Browser deaktiviert haben, der Link dann nicht angezeigt wird. Empfohlene Einstellung: JA.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_HEAD_INFO','<br />Bei der Installation werden bereits einige Standard-Layouts mitgeliefert. Diese können bei Bedarf angepasst, oder auch komplett neue Layouts erstellt werden. Um dies zu vereinfachen kann in der Konfiguration festgelegt werden, ob für die Bearbeitung ein WYSIWYG-Editor, oder ein einfaches Textfeld verwendet werden soll.<br /><br />Sollte die Ausgabe der Komponente im Frontend nach vorgenommenen Änderungen an den <b>Standard-Layouts</b> nicht mehr einwandfrei funktionieren, so kann jederzeit der <b>Originalinhalt</b> (gemeint ist der Zustand nach der Installation) wieder hergestellt werden. Entferne hierzu im entsprechenden Standard-Layout Eingabefeld <b>alle Texte</b> und klicke dann auf <b>Speichern</b>. Die Seite wird dann mit dem Originalinhalt geladen aber noch nicht gespeichert. <b>Vorsicht:</b> vorgenommene Änderungen gehen hierbei verloren.<br /><br />Hinweis: in den Layouts werden etliche Platzhalter (z.B. <font color=darkred>{files}</font>) verwendet. An der Stelle der Platzhalter wird bei der Generierung der eigentlichen Webseite der entsprechende Inhalt eingefügt.<br />');

DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_CATS','Layout: Kategorien');
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_CATS_DESC','Dies ist die Darstellung der <b>Kategorien</b> im Frontend. Wenn du in der Globalen Konfiguration die Option: <b>Startseite mit Kategorienübersicht verwenden</b> aktiviert haben, so werden die Platzhalter {files} und {checkbox_top} nur bei der Darstellung der einzelnen Kategorie berücksichtigt.<br /><br />Die <font color=red>{files} {form_hidden} {form_button} {checkbox_top}</font> Platzhalter sollten <font color=red>NICHT</font> aus dem Code entfernt werden! Entferne den Platzhalter {checkbox_top} nur dann aus dem Code, wenn im Dateien-Layout der Platzhalter {url_download} verwendet wird. Der {files} Tag wird ersetzt mit den Daten die im Layout: "Dateien" angegeben wurden.<br /><br />Verfügbare Platzhalter:<br />{cat_title} {cat_description} {cat_pic} {files} {checkbox_top} {sum_subcats} {sum_files_cat}');
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_CATS_INFO_TITLE','<b>Informationen zum Kategorien Layout:</b>');
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_CATS_INFO_TEXT','<p>Hier siehst du ein grafisches Beispiel für die Darstellung der Kategorie-Beschreibung im Frontend. Der dunkelrote Rahmen, markiert den Bereich dessen Darstellung du hier ändern kannst.</p>');
...
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_FILES_INFO_TEXT','<p>Hier siehst du ein grafisches Beispiel für die Darstellung der Dateiliste im Frontend. Der dunkelrote Rahmen, markiert den Bereich dessen Darstellung du hier ändern kannst.</p>');
...
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_FINAL_INFO_TEXT','<p>Hier siehst du ein grafisches Beispiel für die Darstellung dieser Seite im Frontend. Der dunkelrote Rahmen, markiert den Bereich dessen Darstellung du hier ändern kannst.</p>');

DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_MAIL','Layout: E-Mail');
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_MAIL_DESC','Hier kannst du die Darstellung der <b>E-Mail</b> festlegen, die (sofern aktiviert) nach jedem Download an die in der Konfiguration festgelegte Adresse versendet wird. Es kann HTML-Code sowie beliebiger Text eingefügt werden.<br /><br />Verfügbare Platzhalter:<br /> {file_list} {ip_address} {date_time} {user_name} {user_group}');
...
DEFINE('_JLIST_BACKEND_CATSEDIT_CAT_ACCESS_DESC','Stelle hier die Zugriffsrechte ein. Diese gelten sowohl für diese Kategorie als auch deren Unterkategorien (unabhängig davon welche Rechte diese haben) und die der Kategorie zugeordneten Downloads. <b>Entscheidend für den Zugriff ist immer die Einstellung der übergeordneten Kategorie!</b> Bei der Einstellung "Special" können Mitglieder ab Status Autor, diese Kategorie lesen und downloaden. Wird kein Feld markiert, gilt der Standardzugriff: Jeder kann lesen und downloaden!');
...
//DEFINE('_JLIST_BACKEND_FILESEDIT_FILE_LIST_DESC','Hier kann eine Datei für diesen Download ausgewählt werden, die sich bereits auf dem Server befindet. Es werden nur die Dateien des Kategorie-Verzeichnisses angezeigt, welches der auf der Seite "Grunddaten" markierten Kategorie entspricht.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_UPLOAD_DIR_LIST_INFO_2','Unterverzeichnisse sind <b>nicht</b> beschreibbar! Überprüfe die Zugriffsrechte der Verzeichnisse mit einem FTP-Programm. Die CHMOD Werte müssen auf 0777 stehen.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_LICENSES_LIST','Lizenz auswählen');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_FPIC_DESC','Das ausgewählte Symbol kann über einen Layout-Platzhalter angezeigt werden.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_DADDED_DESC','Gebe die Daten in folgendem Format ein: <b>YYYY-MM-DD H:mm:ss</b> oder verwende die Kalenderfunktion. Wenn nicht anders angegeben, wird automatisch das aktuelle Datum/Zeit eingetragen.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_AUTHOR_URL_DESC','E-Mail Adressen werden vor der Ausgabe verschlüsselt, wenn dies in der Konfiguration entsprechend eingetragen wurde.');
...
DEFINE('_JLIST_BACKEND_TEMPEDIT_NAME_DESCRIPTION','Gebe einen aussagekräftigen Namen für das Layout an.');
DEFINE('_JLIST_BACKEND_TEMPEDIT_TYP_DESCRIPTION','Wähle den passenden Typ für das Layout aus.');
...
DEFINE('_JLIST_BACKEND_EDIT_LANG_CSS_FILE_WRITABLE_INFO','Um Änderungen an der Datei speichern zu können, muss diese beschreibbar sein. Ändere mit einem FTP-Programm die Zugriffsrechte für diese Datei auf CHMOD 0766.');
...
DEFINE('_JLIST_BACKEND_INFO_LICENSE_TEXT','Diese Komponente wird veröffentlicht unter der <a href="http://www.gnu.de/documents/gpl.de.html" target="_blank">GNU/GPL Lizenz</a>.<br />Mit der Installation von jDownloads erkennst Du diese Lizenz sowie die unten aufgeführten Bedingungen an. Wenn Du dies nicht wünschst, so musst Du jDownloads wieder deinstallieren.<br /><br /><b>Weitere Bedingungen:</b><br />Das <b>entfernen des Backlinks</b> auf der Frontpage der Komponente ist <b>nicht erlaubt</b>! Dieser muss ausserdem gut sichtbar sein. Möchtest Du diesen Link trotzdem entfernen, so kann die Erlaubnis dafür gegen Zahlung einer kleinen Gebühr erteilt werden. Nähere Informationen hierzu findest Du auf <a href="http://www.joomlaaddons.de">www.joomlaaddons.de</a>. Oder nehme einfach Kontakt mit mir auf: <a href="mailto:info@joomlaaddons.de">info@joomlaaddons.de</a>.<br /><br />Des weiteren wird diese Erweiterung "so wie sie ist" ohne jegliche Gewährleistung oder Garantie zur Verfügung gestellt! Für mögliche Datenverluste etc. wird daher keinerlei Haftung übernommen. Der Einsatz der Komponente erfolgt auf eigene Verantwortung der installierenden Person.<br /><br /><b>Mein Dank an alle Personen, die mich bei der Entwicklung von jDownloads unterstützt haben.');
...
DEFINE('_JLIST_JAVASCRIPT_TEXT_1','Bitte markiere mindestens eine Datei dieser Kategorie und\\nklicken dann auf die dazugehörende Schaltfläche.');
DEFINE('_JLIST_FRONTEND_SEARCH_RESULT_TEXT_TO_SHORT','Gebe mindestens 3 Zeichen ein!'); 
DEFINE('_JLIST_FRONTEND_SEARCH_RESULT_NO_OPTION','Du musst mindestens eine Suchoption auswählen!'); 
...
DEFINE('_JLIST_BACKEND_FILESEDIT_PRICE_DESC','Gebe den Preis inklusive Währung ein.');

DEFINE('_JLIST_BACKEND_PANEL_TABTEXT_4','Restore Log');

//FRONTEND UPLOAD
DEFINE('_JLIST_FRONTEND_UPLOAD_ACCESS_ONLY_REGGED','Du musst registriert sein um Dateien einreichen zu können. Solltest du bereits registriert sein, so melde dich bitte zuvor auf der Webseite an.');
DEFINE('_JLIST_FRONTEND_UPLOAD_ACCESS_ONLY_SPECIALS','Du verfügst nicht über die Berechtigung Dateien einreichen zu können.');
...
DEFINE('_JLIST_FRONTEND_UPLOAD_ERROR_NO_VALUE','Fehler: Du hast nicht alle Pflichtfelder fehlerfrei ausgefüllt!<br />Bitte korrigiere die markierten Felder.');
DEFINE('_JLIST_FRONTEND_UPLOAD_ERROR_FILETYPE','Fehler: Du hast versucht einen unerlaubten Dateitype einzureichen!<br />Verwende nur die aufgeführten Dateitypen!');
DEFINE('_JLIST_FRONTEND_UPLOAD_ERROR_FILESIZE','Fehler: Du hast versucht eine Datei hochzuladen, welche die maximale Dateigrösse überschreitet!');
...
DEFINE('_JLIST_FRONTEND_UPLOAD_TITEL_NAME','Dein Name:');
DEFINE('_JLIST_FRONTEND_UPLOAD_TITEL_MAIL','Deine E-Mail Adresse:');
...
DEFINE('_JLIST_BACKEND_AUTOCHECK_REFRESH_MESSAGE','Du musst diese Seite aktualisieren um die Änderungen zu sehen!'); 
...
DEFINE('_JLIST_BACKEND_SETTINGS_DEL_TEMPFILE_TIME_DESC','Gebe einen Wert in Minuten an, nach der die temporär erstellten Zip-Dateien für Sammeldownloads vom Server wieder gelöscht werden sollen. Solltest du große Dateien anbieten, so solltest du den Wert höher setzen. Vorgabewert: 20 (Minuten).');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_FILES_PER_SIDE_DESC','Gebe hier die Anzahl der Kategorien/Downloads an, die im Frontend pro Seite angezeigt werden sollen.');

DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_HEADER_TITLE','Titel der im Header angezeigt wird');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_HEADER_DESC','Gebe hier den Titel an, der bei der Ansicht im Frontend im Kopf der Componente angezeigt werden soll, z.B. "Downloads".');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FILETYPES_DESC','Gebe hier die einzelnen Dateiendungen an, welche über das Upload-Formular eingereicht werden dürfen. Zwischen jedem Wert muss ein Komma (,) stehen.');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FILESIZE','Maximale Dateigrösse in KB:');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FILESIZE_DESC','Gebe hier die maximal erlaubte Dateigrösse für eingereichte Dateien in Kilobyte an (1024 KB = 1 MB. Vorgabewert: 2048.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FORM_TEXT_LAYOUT','Hier können Dateien auf den Server hochgeladen werden. Alle mit einem Symbol hervorgehobenen Felder müssen Daten enthalten. Dein Name und E-Mail Adresse werden nicht an Dritte weitergegeben oder veröffentlicht und dienen uns lediglich zur Information.<br />
{form}<br />');

DEFINE('_JLIST_BACKEND_TEMPLIST_DEL_QUEST','Layout(s) löschen?');
DEFINE('_JLIST_BACKEND_LICLIST_DEL_QUEST','Lizenz(en) löschen?');

DEFINE('_JLIST_BACKEND_FILESEDIT_URL_DOWNLOAD_STATUS_DESC','Hier siehst Du den Status des in der Konfiguration angegebenem ROOT Upload Verzeichnis. Ist dieses nicht beschreibbar, so überprüfe mit einem FTP-Programm die Zugriffsrechte. Diese müssen auf CHMOD 0777 stehen.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_FILE_CAT_DESC','Welcher Kategorie soll dieser Download zugeordnet werden. Wähle aus der Liste die gewünschte aus. Wird später eine andere Kategorie ausgewählt, so wird die Download-Datei automatisch in das Verzeichnis der neuen Kategorie verschoben.');
...
//DEFINE('_JLIST_BACKEND_FILESLIST_DEL_FILES_OPTION_YES','Ja');
//DEFINE('_JLIST_BACKEND_FILESLIST_DEL_FILES_OPTION_NO','Nein');
...
DEFINE('_JLIST_BACKEND_CATSEDIT_CAT_TITLE_DESC','Bezeichnung der Kategorie. Da für jeden Kategorietitel ein gleichlautendes Verzeichnis erstellt wird, sind Sonderzeichen nicht erlaubt. Ausnahmen: <b>" - _ . , " </b>sowie Leerzeichen.');
...
DEFINE('_JLIST_BACKEND_CATSEDIT_CAT_LISTBOX_DESC_NEW','Soll eine neue Hauptkategorie angelegt werden, so markiere "Neue Hauptkategorie". Soll die neue Kategorie als Unterkategorie dienen, so markiere die Kategorie die übergeordnet sein soll. Hierin wird dann die Kategorie angelegt. Die Zuordnung kann auch noch zu einem späteren Zeitpunkt geändert werden.');
DEFINE('_JLIST_BACKEND_CATSEDIT_CAT_LISTBOX_DESC','Willst Du eine Kategorie verschieben, so markiere die Kategorie in der die aktuelle Kategorie verschoben werden soll. Soll eine Unterkategorie zukünftig als Hauptkategorie dienen, so markiere "Hauptkategorie".<br /><br /><b>Hinweis:</b> Bei Änderungen hier wird das komplette gleichnamige Verzeichnis auf dem Server automatisch verschoben. Enthält die verschobene Kategorie Unterkategorien, so werden auch diese mit verschoben. Um diese Aktionen nicht zu gefährden, werden beim Editieren einer Kategorie ALLE anderen Kategorien für Änderungen gesperrt!');
...
DEFINE('_JLIST_AUTO_FILE_CHECK_IMPORT_BY','System');          
...
DEFINE('_JLIST_CHECK_CATS_TITEL1','Du hast von einer älteren jDownloads-Version auf die Version 1.2 upgedatet!');     
...
DEFINE('_JLIST_AUTOCHECK_DIR_NOT_EXIST_2','Erstelle die Verzeichnisse /downloads und /downloads/tempzipfiles in deinem Joomla-Hauptverzeichnis per FTP-Programm und setze die Zugriffsrechte auf CHMOD 0777 - andernfalls wird jDownloads nicht funktionieren!');
...
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_DETAILS_INFO_TEXT','<p>Hier siehst du ein grafisches Beispiel für die Detaildarstellung eines Downloads im Frontend. Der dunkelrote Rahmen, markiert den Bereich dessen Darstellung Sie hier ändern können.</p>');
...
DEFINE('_JLIST_BACKEND_TEMPEDIT_CHECKBOX_DESC','Wenn ja, wird bei der Ausgabe die Checkbox-Kopfzeile und der "Weiter" Button  angezeigt. Ausserdem muss dann der Platzhalter <b>{checkbox_list}</b> im Layout eingefügt werden. Wenn nein, muss stattdessen der Platzhalter <b>{url_download}</b> im Layout eingefügt/verwendet werden.'); 
...
DEFINE('_JLIST_SAMPLE_DATA_CAT_NAME_TEXT','Hier eine Beispiel Kategorie zur Veranschaulichung. Diese kannst Du jederzeit wieder löschen.');
DEFINE('_JLIST_SAMPLE_DATA_FILE_NAME','Beispiel Download');
DEFINE('_JLIST_SAMPLE_DATA_FILE_NAME_TEXT','Hier ein Beispiel Download zur Veranschaulichung. Diese kannst Du jederzeit wieder löschen.');
DEFINE('_JLIST_SAMPLE_DATA_CREATE_ERROR','Auf Grund eines Fehlers konnten die Beispieldaten nicht erstellt werden! Nutze die Option im Hauptmenü von jDownloads.');
...
DEFINE('_JLIST_FRONTEND_FILE_NOT_FOUND_MESSAGE','Die angeforderte Datei wurde nicht gefunden!<br /><br />Bitte informiere den Webmaster darüber!');
...
DEFINE('_JLIST_BACKEND_SETTINGS_HOT_DESC','Gebe hier die Anzahl an Downloads an, ab der ein Download als "HOT" (beliebt) gelten soll. Hinter dem Download-Titel wird dann das unten angegebene Symbol angezeigt. Bei 0 wird kein Symbol angezeigt.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_NEW_DESC','Gebe hier die Anzahl Tage an, wie lange ein Download als "neu" gelten soll. Hinter dem Download-Titel wird dann das unten angegebene Symbol angezeigt. Bei 0 wird kein Symbol angezeigt.');
...
// NEW IN 1.2 stable
DEFINE('_JLIST_BACKEND_DIRSEDIT_CREATE_DIR_MESSAGE_ERROR','Fehler: Verzeichnis konnte nicht erstellt werden! Überprüfe die Zugriffsrechte der Verzeichnisse mit einem FTP-Programm. Die CHMOD Werte müssen auf 0777 stehen.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_SORTCATSORDER_DESC','Sortierreihenfolge der Kategorien bei der Darstellung im Frontend. Wenn die im Backend standardmäßig vorgenommene Sortierung verwendet werden soll, so wähle: "Standard".');
...
DEFINE('_JLIST_BACKEND_FILES_COPY_DESC','Wähle die Kategorie aus, in der Kopien der ausgewählten Downloads erstellt werden sollen.');
DEFINE('_JLIST_BACKEND_FILES_COPY_TEXT_1','Folgende Downloads werden kopiert:');
DEFINE('_JLIST_BACKEND_FILES_COPY_TEXT_2','Hinweis: Wenn du die gleiche Kategorie als Ziel auswählst, wird darin eine "Kopie von <i>Downloadbezeichner</i>" angelegt!');
...
DEFINE('_JLIST_FE_DETAILS_MODIFIED_BY_TITLE','Geändert von');
DEFINE('_JLIST_FE_DETAILS_MODIFIED_DATE_TITLE','Geändert am');

// FOR EXTERN FILES -  USER INFO IF CHECKBOXES ACTIVE
// PLEASE USE NOT SPECIAL CHARS e.g. " ' & ...
DEFINE('_JLIST_FRONTEND_EXTERN_FILE_USER_INFO','Dieser Download muss separat herunter geladen werden, da die Datei sich auf einem anderen Server befindet. Somit ist dieser Download für einen Sammel-Download nicht geeignet.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_EMAIL_INFO_TEXT','<p>Hier siehst du ein grafisches Beispiel für die Darstellung dieser Informationen in der übermittelten E-Mail. Der dunkelrote Rahmen, markiert den Bereich dessen Darstellung du hier ändern kannst.</p>');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_ERROR_ONLY_MIRROR','Fehler: Gebe zuerst eine interne oder externe Datei an. Ein Mirror Link ist nur zusätzlich möglich.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_VIEW_FILE_TYPES_DESC','Gebe hier die Dateitypen an, welche nicht als Download angeboten werden sollen. Diese werden in einem neuen Browserfenster zur Ansicht geöffnet. Zwischen jedem Wert muss ein Komma (,) stehen. Beispiel: html,htm,txt,pdf,doc,jpg,jpeg,png,gif');
...
DEFINE('_JLIST_FRONTEND_DOWNLOAD_GO_TO_OTHER_SITE_INFO','Die angeforderte Datei befindet sich auf einer fremden Website.<br />Bitte folge den Hinweisen dort um den Download zu starten.');
...
DEFINE('_JLIST_FE_SUMMARY_PAGE_LICENSE_NOTE','Mit dem Download erkennst du die jeweiligen Lizenzbedingungen an.');
DEFINE('_JLIST_FE_SUMMARY_PAGE_TITLE_TEXT','Hier siehst du eine Aufstellung der von dir zum Download ausgewählten Dateien');

// NEW INSTALL MESSAGES FOR UPDATE
DEFINE('_JLIST_INSTALL_WARNING_CAT_ACCESS_RIGHTS','Einige Kategorie Zugriffsrechte mussten korrigiert werden. Überprüfe daher die Kategorien vor der Veröffentlichung!');
