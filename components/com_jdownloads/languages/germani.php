...
DEFINE('_JLIST_FILE_NOT_FOUND','Die angeforderte Datei wurde leider nicht gefunden. Bitte kontaktiere den Betreiber dieser Webseite und informiere Ihn dar&uuml;ber.');
...
DEFINE('_JLIST_FRONTEND_CAT_ACCESS_REGGED','Diese Kategorie erfordert eine Registrierung um Daten downloaden zu k&ouml;nnen.<br />Solltest du bereits registriert sein, so melde dich  bitte an.<br /><br />');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_COMPO_TEXT_DESC','Optionaler Text der <b>zwischen</b> Komponententitel und den Kategorien angezeigt wird. Den Komponententitel kannst du ebenfalls in der Konfiguration festlegen.<br /><br />Es k&ouml;nnen CSS-Klassen, HTML-Code sowie beliebiger Text eingef&uuml;gt werden.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_SORTFILESORDER_DESC','Sortierreihenfolge der Dateien bei der Darstellung im Frontend. Wenn die im Backend standardm&auml;&szlig;ig vorgenommene Sortierung verwendet werden soll, so w&auml;hle: "Standard".');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_CATPICS_SIZE_DESC','Gr&ouml;sse in der die Kategorie Symbole angezeigt werden sollen. Es k&ouml;nnen auch eigene Symbole verwendet werden, lade hierzu einfach die Symbole &uuml;ber ein FTP-Programm in das Unterverzeichnis: /catimages. Die Symbole stehen dann automatisch zur Auswahl. Standard: 48');

DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_FILEPICS_SIZE','Gr&ouml;sse der Datei Symbole in Pixel');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_FILEPICS_SIZE_DESC','Gr&ouml;sse in der die Datei Symbole angezeigt werden sollen. Es k&ouml;nnen auch eigene Symbole verwendet werden, lade hierzu einfach die Symbole &uuml;ber ein FTP-Programm in das Unterverzeichnis: /fileimages. Die Symbole stehen dann automatisch zur Auswahl. Standard: 32');
...
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_FILES_INFO_TEXT','<p>Hier siehst du ein grafisches Beispiel f&uuml;r die Darstellung der Dateiliste im Frontend. Der dunkelrote Rahmen, markiert den Bereich dessen Darstellung du hier &auml;ndern kannst.</p>');
...
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_FINAL_INFO_TEXT','<p>Hier siehst du ein grafisches Beispiel f&uuml;r die Darstellung dieser Seite im Frontend. Der dunkelrote Rahmen, markiert den Bereich dessen Darstellung du hier &auml;ndern kannst.</p>');
...
//DEFINE('_JLIST_BACKEND_FILESEDIT_FILE_LIST_DESC','Hier kann eine Datei f&uuml;r diesen Download ausgew&auml;hlt werden, die sich bereits auf dem Server befindet. Es werden nur die Dateien des Kategorie-Verzeichnisses angezeigt, welches der auf der Seite "Grunddaten" markierten Kategorie entspricht.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_UPLOAD_DIR_LIST_INFO_2','Unterverzeichnisse sind <b>nicht</b> beschreibbar! &Uuml;berpr&uuml;fe die Zugriffsrechte der Verzeichnisse mit einem FTP-Programm. Die CHMOD Werte m&uuml;ssen auf 0777 stehen.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_FPIC_DESC','Das ausgew&auml;hlte Symbol kann &uuml;ber einen Layout-Platzhalter angezeigt werden.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_AUTHOR_URL_DESC','E-Mail Adressen werden vor der Ausgabe verschl&uuml;sselt, wenn dies in der Konfiguration entsprechend eingetragen wurde.');
...
DEFINE('_JLIST_BACKEND_TEMPEDIT_NAME_DESCRIPTION','Gebe einen aussagekr&auml;ftigen Namen f&uuml;r das Layout an.');
DEFINE('_JLIST_BACKEND_TEMPEDIT_TYP_DESCRIPTION','W&auml;hle den passenden Typ f&uuml;r das Layout aus.');
...
DEFINE('_JLIST_BACKEND_EDIT_LANG_CSS_FILE_WRITABLE_INFO','Um &Auml;nderungen an der Datei speichern zu k&ouml;nnen, muss diese beschreibbar sein. &Auml;ndere mit einem FTP-Programm die Zugriffsrechte f&uuml;r diese Datei auf CHMOD 0766.');
...
DEFINE('_JLIST_BACKEND_INFO_LICENSE_TEXT','Diese Komponente wird ver&ouml;ffentlicht unter der <a href="http://www.gnu.de/documents/gpl.de.html" target="_blank">GNU/GPL Lizenz</a>.<br />Mit der Installation von jDownloads erkennst Du diese Lizenz sowie die unten aufgef&uuml;hrten Bedingungen an. Wenn Du dies nicht w&uuml;nschst, so musst Du jDownloads wieder deinstallieren.<br /><br /><b>Weitere Bedingungen:</b><br />Das <b>entfernen des Backlinks</b> auf der Frontpage der Komponente ist <b>nicht erlaubt</b>! Dieser muss ausserdem gut sichtbar sein. M&ouml;chtest Du diesen Link trotzdem entfernen, so kann die Erlaubnis daf&uuml;r gegen Zahlung einer kleinen Geb&uuml;hr erteilt werden. N&auml;here Informationen hierzu findest Du auf <a href="http://www.joomlaaddons.de">www.joomlaaddons.de</a>. Oder nehme einfach Kontakt mit mir auf: <a href="mailto:info@joomlaaddons.de">info@joomlaaddons.de</a>.<br /><br />Des weiteren wird diese Erweiterung "so wie sie ist" ohne jegliche Gew&auml;hrleistung oder Garantie zur Verf&uuml;gung gestellt! F&uuml;r m&ouml;gliche Datenverluste etc. wird daher keinerlei Haftung &uuml;bernommen. Der Einsatz der Komponente erfolgt auf eigene Verantwortung der installierenden Person.<br /><br /><b>Mein Dank an alle Personen, die mich bei der Entwicklung von jDownloads unterst&uuml;tzt haben.');
...
DEFINE('_JLIST_INSTALL_19','Wenn du diese zu einem späteren Zeitpunkt mit JoomFish verwenden willst, verwenden den Installer von JoomFish hierzu.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_PRICE_DESC','Gebe den Preis inklusive W&auml;hrung ein.');

DEFINE('_JLIST_BACKEND_PANEL_TABTEXT_4','Restore Log');

//FRONTEND UPLOAD
DEFINE('_JLIST_FRONTEND_UPLOAD_ACCESS_ONLY_REGGED','Du musst registriert sein um Dateien einreichen zu k&ouml;nnen. Solltest du bereits registriert sein, so melde dich bitte zuvor auf der Webseite an.');
DEFINE('_JLIST_FRONTEND_UPLOAD_ACCESS_ONLY_SPECIALS','Du verf&uuml;gst nicht &uuml;ber die Berechtigung Dateien einreichen zu k&ouml;nnen.');
...
DEFINE('_JLIST_FRONTEND_UPLOAD_ERROR_NO_VALUE','Fehler: Du hast nicht alle Pflichtfelder fehlerfrei ausgef&uuml;llt!<br />Bitte korrigiere die markierten Felder.');
DEFINE('_JLIST_FRONTEND_UPLOAD_ERROR_FILETYPE','Fehler: Du hast versucht einen unerlaubten Dateitype einzureichen!<br />Verwende nur die aufgef&uuml;hrten Dateitypen!');
DEFINE('_JLIST_FRONTEND_UPLOAD_ERROR_FILESIZE','Fehler: Du hast versucht eine Datei hochzuladen, welche die maximale Dateigr&ouml;sse &uuml;berschreitet!');
...
DEFINE('_JLIST_BACKEND_AUTOCHECK_REFRESH_MESSAGE','Du musst diese Seite aktualisieren um die &Auml;nderungen zu sehen!'); 
...
DEFINE('_JLIST_BACKEND_SETTINGS_DEL_TEMPFILE_TIME_DESC','Gebe einen Wert in Minuten an, nach der die tempor&auml;r erstellten Zip-Dateien f&uuml;r Sammeldownloads vom Server wieder gel&ouml;scht werden sollen. Solltest du gro&szlig;e Dateien anbieten, so solltest du den Wert h&ouml;her setzen. Vorgabewert: 20 (Minuten).');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FILETYPES_DESC','Gebe hier die einzelnen Dateiendungen an, welche &uuml;ber das Upload-Formular eingereicht werden d&uuml;rfen. Zwischen jedem Wert muss ein Komma (,) stehen.');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FILESIZE','Maximale Dateigr&ouml;sse in KB:');
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_UPLOADS_FILESIZE_DESC','Gebe hier die maximal erlaubte Dateigr&ouml;sse f&uuml;r eingereichte Dateien in Kilobyte an (1024 KB = 1 MB. Vorgabewert: 2048.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_URL_DOWNLOAD_STATUS_DESC','Hier siehst Du den Status des in der Konfiguration angegebenem ROOT Upload Verzeichnis. Ist dieses nicht beschreibbar, so &uuml;berpr&uuml;fe mit einem FTP-Programm die Zugriffsrechte. Diese m&uuml;ssen auf CHMOD 0777 stehen.');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_FILE_CAT_DESC','Welcher Kategorie soll dieser Download zugeordnet werden. W&auml;hle aus der Liste die gew&uuml;nschte aus. Wird sp&auml;ter eine andere Kategorie ausgew&auml;hlt, so wird die Download-Datei automatisch in das Verzeichnis der neuen Kategorie verschoben.');
...
DEFINE('_JLIST_BACKEND_CATSEDIT_CAT_LISTBOX_DESC_NEW','Soll eine neue Hauptkategorie angelegt werden, so markiere "Neue Hauptkategorie". Soll die neue Kategorie als Unterkategorie dienen, so markiere die Kategorie die &uuml;bergeordnet sein soll. Hierin wird dann die Kategorie angelegt. Die Zuordnung kann auch noch zu einem sp&auml;teren Zeitpunkt ge&auml;ndert werden.');
DEFINE('_JLIST_BACKEND_CATSEDIT_CAT_LISTBOX_DESC','Willst Du eine Kategorie verschieben, so markiere die Kategorie in der die aktuelle Kategorie verschoben werden soll. Soll eine Unterkategorie zuk&uuml;nftig als Hauptkategorie dienen, so markiere "Hauptkategorie".<br /><br /><b>Hinweis:</b> Bei &Auml;nderungen hier wird das komplette gleichnamige Verzeichnis auf dem Server automatisch verschoben. Enth&auml;lt die verschobene Kategorie Unterkategorien, so werden auch diese mit verschoben. Um diese Aktionen nicht zu gef&auml;hrden, werden beim Editieren einer Kategorie ALLE anderen Kategorien f&uuml;r &Auml;nderungen gesperrt!');
...
DEFINE('_JLIST_CHECK_CATS_TITEL1','Du hast von einer &auml;lteren jDownloads-Version auf die Version 1.2 upgedatet!');     
...
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_DETAILS_INFO_TEXT','<p>Hier siehst du ein grafisches Beispiel f&uuml;r die Detaildarstellung eines Downloads im Frontend. Der dunkelrote Rahmen, markiert den Bereich dessen Darstellung Sie hier &auml;ndern k&ouml;nnen.</p>');
...
DEFINE('_JLIST_SAMPLE_DATA_CAT_NAME_TEXT','Hier eine Beispiel Kategorie zur Veranschaulichung. Diese kannst Du jederzeit wieder l&ouml;schen.');
DEFINE('_JLIST_SAMPLE_DATA_FILE_NAME','Beispiel Download');
DEFINE('_JLIST_SAMPLE_DATA_FILE_NAME_TEXT','Hier ein Beispiel Download zur Veranschaulichung. Diese kannst Du jederzeit wieder l&ouml;schen.');
DEFINE('_JLIST_SAMPLE_DATA_CREATE_ERROR','Auf Grund eines Fehlers konnten die Beispieldaten nicht erstellt werden! Nutze die Option im Hauptmen&uuml; von jDownloads.');
...
DEFINE('_JLIST_FRONTEND_FILE_NOT_FOUND_MESSAGE','Die angeforderte Datei wurde nicht gefunden!<br /><br />Bitte informiere den Webmaster dar&uuml;ber!');
...
// NEW IN 1.2 stable
DEFINE('_JLIST_BACKEND_DIRSEDIT_CREATE_DIR_MESSAGE_ERROR','Fehler: Verzeichnis konnte nicht erstellt werden! &Uuml;berpr&uuml;fe die Zugriffsrechte der Verzeichnisse mit einem FTP-Programm. Die CHMOD Werte m&uuml;ssen auf 0777 stehen.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_SORTCATSORDER_DESC','Sortierreihenfolge der Kategorien bei der Darstellung im Frontend. Wenn die im Backend standardm&auml;&szlig;ig vorgenommene Sortierung verwendet werden soll, so w&auml;hle: "Standard".');
...
DEFINE('_JLIST_BACKEND_SETTINGS_DOWNLOADS_AUTOPUBLISH_DESC','Wenn Ja, werden neu gefundene Dateien sofort veröffentlicht. Vorrausgesetzt, die Option zur &Uuml;berwachung der Downloads oben ist aktiviert.<br /><b>Standard Einstellung: Nein.</b>');
...
DEFINE('_JLIST_BACKEND_FILES_COPY_DESC','W&auml;hle die Kategorie aus, in der Kopien der ausgew&auml;hlten Downloads erstellt werden sollen.');
DEFINE('_JLIST_BACKEND_FILES_COPY_TEXT_1','Folgende Downloads werden kopiert:');
DEFINE('_JLIST_BACKEND_FILES_COPY_TEXT_2','Hinweis: Wenn du die gleiche Kategorie als Ziel ausw&auml;hlst, wird darin eine "Kopie von <i>Downloadbezeichner</i>" angelegt!');
...
DEFINE('_JLIST_BACKEND_SETTINGS_TEMPLATES_EMAIL_INFO_TEXT','<p>Hier siehst du ein grafisches Beispiel f&uuml;r die Darstellung dieser Informationen in der &uuml;bermittelten E-Mail. Der dunkelrote Rahmen, markiert den Bereich dessen Darstellung du hier &auml;ndern kannst.</p>');
...
DEFINE('_JLIST_BACKEND_FILESEDIT_ERROR_ONLY_MIRROR','Fehler: Gebe zuerst eine interne oder externe Datei an. Ein Mirror Link ist nur zus&auml;tzlich m&ouml;glich.');
...
DEFINE('_JLIST_BACKEND_SETTINGS_FRONTEND_VIEW_FILE_TYPES_DESC','Gebe hier die Dateitypen an, welche nicht als Download angeboten werden sollen. Diese werden in einem neuen Browserfenster zur Ansicht ge&ouml;ffnet. Zwischen jedem Wert muss ein Komma (,) stehen. Beispiel: html,htm,txt,pdf,doc,jpg,jpeg,png,gif');
...
DEFINE('_JLIST_FE_SUMMARY_PAGE_TITLE_TEXT','Hier siehst du eine Aufstellung der von dir zum Download ausgew&auml;hlten Dateien');

// NEW INSTALL MESSAGES FOR UPDATE
DEFINE('_JLIST_INSTALL_WARNING_CAT_ACCESS_RIGHTS','Einige Kategorie Zugriffsrechte mussten korrigiert werden. Überpr&uuml;fe daher die Kategorien vor der Ver&ouml;ffentlichung!');
