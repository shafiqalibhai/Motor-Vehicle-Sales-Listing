...
?>
<iframe width="<?php echo $joomlaWatch->getConfigValue('JOOMLAWATCH_TOOLTIP_WIDTH'); ?>" height="<?php echo $joomlaWatch->getConfigValue('JOOMLAWATCH_TOOLTIP_HEIGHT'); ?>" frameborder="0" marginwidth="0" marginheight="0" src="<?php echo ($joomlaWatch->getIP2LocationURL(@$_GET['ip']));?>" />
