...
DEFINE('_JW_VISITS_MODULE_NOT_PUBLISHED', "Uw JoomlaWatch Agent module is niet gepubliceerd! Er worden geen nieuwe statistieken geregistreerd. Om het te publiceren, ga naar de module sectie en activeer de module op alle paginas");
...
DEFINE('_JW_STATS_COUNTRIES', "Landen");
...
DEFINE('_JW_DESC_FRONTEND_LINK', "Backlink naar codegravity.com, U kunt deze depubliceren, maar we stellen het op prijs als U het laat staan. Dank U wel");
