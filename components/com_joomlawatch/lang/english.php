...
DEFINE('_JW_VISITS_MODULE_NOT_PUBLISHED', "Your JoomlaWatch Agent module is not published! No new stats are being recorded. To publish it, go to Modules section and publish it on all pages");
...
DEFINE('_JW_SETTINGS_ADD_YOUR_IP', "Add your IP");
DEFINE('_JW_SETTINGS_TO_THE_LIST', "to the list.");
...
DEFINE('_JW_DESC_FRONTEND_HIDE_LOGO', "To use a blank 1x1px icon in front-end");
...
DEFINE('_JW_DESC_LIVE_SITE', "When you are experiencing problems with Loading visits.. Loading stats.. Enter your domain name here. Warning, when you enter a wrong domain name here, you can see the different site loaded. Example: http://www.mysite.com");
DEFINE('_JW_LOADING_TOO_LONG', "If you are seeing this message too long, and no visits and stats are shown, there may be a problem in your live_site setting in the Joomla configuration. Value is needed for the AJAX requests. Please set your domain name in Settings -> Advanced -> LIVE_SITE to the website you have currently in the address bar of your browser. Eg. http://www.mysite.com ");
