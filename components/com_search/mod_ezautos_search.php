...
<div align="center"><img src="images/cars8x194.jpg" width="258" height="168"> 
</div>
  ...
  <tr> 
    <td> <form name="searchfilter" action="<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;task=results&amp;Itemid=$myItemid");?>" method="post">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="5">
          ...
          <?php if ($usemileage) { ?>
          <tr> 
            <td><strong><?php echo _EZAUTOS_MAXMILB;?>:-</strong><br /> <input name="maxmiles" class="searchbox" maxlength="10" type="text" />
            </td>
          </tr>
          <?php } ?>
          <?php if ($usepcode) { ?>
