...
<!--START IMAGE TABLE-->			
			...
			<table border="0" cellspacing="2" cellpadding="1">
				<tr>
					<?php if ( $myimage2 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic01')" href="<?php echo $myimage1;?>" rel="lightbox[car]" title=""><img src="<?php echo $myimage1;?>" border="0" width="<?php echo $ea_thumbwidth;?>" alt="" /></a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } if ( $myimage2 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic02')" href="<?php echo $myimage2;?>" rel="lightbox[car]" title=""><img src="<?php echo $myimage2;?>" border="0" width="<?php echo $ea_thumbwidth;?>" alt="" /></a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } if ( $myimage3 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic03')" href="<?php echo $myimage3;?>" rel="lightbox[car]" title=""><img src="<?php echo $myimage3;?>" border="0" width="<?php echo $ea_thumbwidth;?>" alt="" /></a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } if ( $myimage4 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic04')" href="<?php echo $myimage4;?>" rel="lightbox[car]" title=""><img src="<?php echo $myimage4;?>" border="0" width="<?php echo $ea_thumbwidth;?>" alt="" /></a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } ?>
				</tr>
				...
				<tr>
					<?php if ( $myimage9 ){ ?>
					<td valign='top' align='center'><a onmouseover="doButtons('pic09')" href="<?php echo $myimage9;?>" rel="lightbox[car]" title=""> </a></td>
					<?php }else{ ?>
					<td valign='top' align='center'> </td>
					<?php } if ( $myimage10 ){ ?>
					<td valign='top' align='center'><a onmouseover="doButtons('pic10')" href="<?php echo $myimage10;?>" rel="lightbox[car]" title=""> </a></td>
					<?php }else{ ?>
					<td valign='top' align='center'> </td>
					<?php } if ( $myimage11 ){ ?>
					<td valign='top' align='center'><a onmouseover="doButtons('pic11')" href="<?php echo $myimage11;?>" rel="lightbox[car]" title=""> </a></td>
					<?php }else{ ?>
					<td valign='top' align='center'> </td>
					<?php } if ( $myimage12 ){ ?>
					<td valign='top' align='center'><a onmouseover="doButtons('pic12')" href="<?php echo $myimage12;?>" rel="lightbox[car]" title=""> </a></td>
					<?php }else{ ?>
					<td valign='top' align='center'> </td>
					<?php } ?>
				</tr>
				...
				<tr>
					<?php if ( $myimage13 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic13')" href="<?php echo $myimage13;?>" rel="lightbox[car]" title=""> </a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } if ( $myimage14 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic14')" href="<?php echo $myimage14;?>" rel="lightbox[car]" title=""> </a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } if ( $myimage15 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic15')" href="<?php echo $myimage15;?>" rel="lightbox[car]" title=""> </a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } if ( $myimage16 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic16')" href="<?php echo $myimage16;?>" rel="lightbox[car]" title=""> </a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } ?>
				</tr>
