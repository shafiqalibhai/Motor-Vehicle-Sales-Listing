...
<!--START IMAGE TABLE-->			
							...
							<tr>
								<td valign="top" align="center">
									<div id="watermark_box">
										<?php if ($row->image1) { ?>
										<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/<?php echo $ea_imagedirectory.'/'.$row->image1;?>" height="<?php echo $ea_imgheight;?>" border="1" name="picture" alt="<?php echo _EZAUTOS_HOVER;?>" />
										<?php }else{ ?>
										...
										<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/sold.png" class="watermark" alt="" />
										<?php } ?>
										<?php if ( $row->featured==1 && $row->availability!=_EZAUTOS_AVAIL_SOLD ){ ?>
										<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/wow.png" class="watermark" alt="" />
										<?php } ?>
										<?php } ?>
									</div>
								</td>
			...
			<table border="0" cellspacing="2" cellpadding="1">
				<tr>
					<?php if ( $row->image2 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic01')" href="components/com_ezautos/<?php echo $ea_imagedirectory;?>/<?php echo $row->image1;?>" rel="lightbox[car]" title="<?php echo $row->image1desc;?>"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/<?php echo $ea_imagedirectory;?><?php if ( $ea_thumbcreation !== 'none' ) { ?>/th<?php } ?>/<?php echo $row->image1;?>" width="<?php echo $ea_thumbwidth;?>" border="0" alt="<?php echo $row->image1desc;?>" title="<?php echo $row->image1desc;?>" /></a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } if ( $row->image2 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic02')" href="components/com_ezautos/<?php echo $ea_imagedirectory;?>/<?php echo $row->image2;?>" rel="lightbox[car]" title="<?php echo $row->image2desc;?>"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/<?php echo $ea_imagedirectory;?><?php if ( $ea_thumbcreation !== 'none' ) { ?>/th<?php } ?>/<?php echo $row->image2;?>" width="<?php echo $ea_thumbwidth;?>" border="0" alt="<?php echo $row->image2desc;?>" title="<?php echo $row->image2desc;?>" /></a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } if ( $row->image3 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic03')" href="components/com_ezautos/<?php echo $ea_imagedirectory;?>/<?php echo $row->image3;?>" rel="lightbox[car]" title="<?php echo $row->image3desc;?>"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/<?php echo $ea_imagedirectory;?><?php if ( $ea_thumbcreation !== 'none' ) { ?>/th<?php } ?>/<?php echo $row->image3;?>" width="<?php echo $ea_thumbwidth;?>" border="0" alt="<?php echo $row->image3desc;?>" title="<?php echo $row->image3desc;?>" /></a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } if ( $row->image4 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic04')" href="components/com_ezautos/<?php echo $ea_imagedirectory;?>/<?php echo $row->image4;?>" rel="lightbox[car]" title="<?php echo $row->image4desc;?>"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/<?php echo $ea_imagedirectory;?><?php if ( $ea_thumbcreation !== 'none' ) { ?>/th<?php } ?>/<?php echo $row->image4;?>" width="<?php echo $ea_thumbwidth;?>" border="0" alt="<?php echo $row->image4desc;?>" title="<?php echo $row->image4desc;?>" /></a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } ?>
				</tr>
				<tr>
					...
					<td valign="top" align="center"> </td>
					<?php } if ( $row->image7 ){ ?>
					<td valign="top" align="center"><a onmouseover="doButtons('pic07')" href="components/com_ezautos/<?php echo $ea_imagedirectory;?>/<?php echo $row->image7;?>" rel="lightbox[car]" title="<?php echo $row->image7desc;?>"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/<?php echo $ea_imagedirectory;?><?php if ( $ea_thumbcreation !== 'none' ) { ?>/th<?php } ?>/<?php echo $row->image7;?>" width="<?php echo $ea_thumbwidth;?>" border="0" alt="<?php echo $row->image7desc;?>" title="<?php echo $row->image7desc;?>" /></a></td>
					<?php }else{ ?>
					<td valign="top" align="center"> </td>
					<?php } if ( $row->image8 ){ ?>
					<td valign="top" align="center"><a onmouseover="doButtons('pic08')" href="components/com_ezautos/<?php echo $ea_imagedirectory;?>/<?php echo $row->image8;?>" rel="lightbox[car]" title="<?php echo $row->image8desc;?>"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/<?php echo $ea_imagedirectory;?><?php if ( $ea_thumbcreation !== 'none' ) { ?>/th<?php } ?>/<?php echo $row->image8;?>" width="<?php echo $ea_thumbwidth;?>" border="0" alt="<?php echo $row->image8desc;?>" title="<?php echo $row->image8desc;?>" /></a></td>
					<?php }else{ ?>
					<td valign="top" align="center"> </td>
					<?php } ?>
				</tr>
				...
				<tr>
					<?php if ( $row->image13 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic13')" href="components/com_ezautos/<?php echo $ea_imagedirectory;?>/<?php echo $row->image13;?>" rel="lightbox[car]" title="<?php echo $row->image13desc;?>"> </a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } if ( $row->image14 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic14')" href="components/com_ezautos/<?php echo $ea_imagedirectory;?>/<?php echo $row->image14;?>" rel="lightbox[car]" title="<?php echo $row->image14desc;?>"> </a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } if ( $row->image15 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic15')" href="components/com_ezautos/<?php echo $ea_imagedirectory;?>/<?php echo $row->image15;?>" rel="lightbox[car]" title="<?php echo $row->image15desc;?>"> </a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } if ( $row->image16 ){ ?>
					<td valign="top" align="center" width="25%"><a onmouseover="doButtons('pic16')" href="components/com_ezautos/<?php echo $ea_imagedirectory;?>/<?php echo $row->image16;?>" rel="lightbox[car]" title="<?php echo $row->image16desc;?>"> </a></td>
					<?php }else{ ?>
					<td valign="top" align="center" width="25%"> </td>
					<?php } ?>
				</tr>
