...
?>
			...
			<input type="hidden" name="item_name" value="<?php echo stripslashes( _EZAUTOS_FEATURED );?>" />
			<input type="hidden" name="item_number" value="EZA2" />
			<input type="hidden" name="amount" value="<?php echo $featured_cost;?>" />
			...
			<input type="hidden" name="cancel_return" value="<?php echo $mosConfig_live_site; ?>/index.php?option=com_ezautos&amp;task=cancel" />
			<input type="hidden" name="no_note" value="1" />
			<input type="hidden" name="notify_url" value="<?php echo $mosConfig_live_site; ?>/index.php?option=com_ezautos&amp;Itemid=<?php echo $myItemid;?>&amp;task=upgrade3" />
