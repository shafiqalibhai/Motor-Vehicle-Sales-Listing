...
?>
			...
			<input type="hidden" name="item_number" value="EZA1" />
			...
			<input type="hidden" name="notify_url" value="<?php echo $mosConfig_live_site; ?>/index.php?option=com_ezautos&amp;Itemid=<?php echo $myItemid;?>&amp;task=upgrade1" />
