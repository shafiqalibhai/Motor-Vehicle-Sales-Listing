...
<table cellspacing="0" cellpadding="0" border="0" width="99%">
    <tbody>
        ...
        <tr>
            <td style="text-align: center;"><span style="color: rgb(255, 255, 255);"><a href="index.php?option=com_ezautos&amp;task=listall&amp;Itemid=53">Advanced Search&#160; </a></span></td>
...
<!--START VEHICLE SUMMARY TABLE-->			
			...
			<div align="center">
				<table width="100%">
					<tr>
						<td class='sectiontableheader' align="left"><?php echo _EZAUTOS_LISTINGS_SUMMARY;?></td>
					</tr>
					<tr>
						<td>
							<div align="center">
