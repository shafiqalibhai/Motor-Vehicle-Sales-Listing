	...
	<tr>
		<td valign="top" width="60%">
			<table border="0" width="100%" cellspacing="3" cellpadding="3">
				...
				<tr>
					<td align="left">&nbsp;<strong><?php echo _EZAUTOS_DET_PRICE; ?>&nbsp;:</strong>&nbsp;&nbsp;
<?php
...
?>
				...
				<?php } ?>
									...
									<?php if ( $row->incltax ) { ?>
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_SPECS_TAX; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo _EZAUTOS_DET_YES; ?></td>
									</tr>
									<?php } ?>

									<?php if ( $row->onroad > "0.00" ) { ?>
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_SPECS_ONROAD; ?>&nbsp;:</strong>&nbsp;&nbsp;
				...
				<?php if ( $row->engine ) { ?>
				<tr>
					<td>&nbsp;<strong><?php echo _EZAUTOS_DET_ENGSIZE; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->engine;?></td>
				</tr>
				<?php } ?>
									<?php if ( $row->trans ) { ?>
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_DET_TRANSMISSION; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->trans;?></td>
									</tr>
									<?php } ?>
									<?php if ( $row->fuel ) { ?>
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_VLDET_FUEL; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->fuel;?></td>
									</tr>
									<?php } ?>
									<?php if ( $row->odometer ) { ?>
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_DET_MILEAGE; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->odometer.' '.$row->mileage_unit;?></td>
									</tr>
									<?php } ?>
									<?php if ( !$row->odometer && $row->mileage ) { ?>
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_DET_MILEAGE; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->mileage;?></td>
									</tr>
									<?php } ?>
									<?php if ( $row->colour ) { ?>
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_DETAILS_EXTCOLOUR; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->colour;?></td>
									</tr>
									<?php } ?>

									<?php if ( $row->intcolour ) { ?>
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_DETAILS_INTCOLOUR; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->intcolour;?></td>
									</tr>
									<?php } ?>
									<?php if ( $row->doors ) { ?>
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_SPECS_DOORS;?>&nbsp;:</strong>&nbsp;&nbsp;
...
?>
									...
									<?php if ( $row->body ) { ?>
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_SPECS_BODY;?>&nbsp;:</strong>&nbsp;&nbsp;
...
?>
									...
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_SPECS_DOORSBODY;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->doorsbody;?></td>
									</tr>
									<?php } ?>
				<?php if ( $row->year ) { ?>
				<tr>
					<td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_YOM;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->year;?></td>
				</tr>
				<?php } ?>

								<?php if ( $row->yearreg ) { ?>
								<tr>
									<td align="left">&nbsp;<strong><?php echo _EZAUTOS_SPECS_MONTHYEAR_FIRSTREG;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->monthreg.'/'.$row->yearreg;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->yearinsp ) { ?>
								<tr>
									<td align="left">&nbsp;<strong><?php echo _EZAUTOS_SPECS_MONTHYEAR_NEXTINSPECTION;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->monthinsp.'/'.$row->yearinsp;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->yearemiss ) { ?>
								<tr>
									<td align="left">&nbsp;<strong><?php echo _EZAUTOS_SPECS_MONTHYEAR_NEXTEMISSIONSINSP;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->monthemiss.'/'.$row->yearemiss;?></td>
								</tr>
								<?php } ?>

									<?php if ( $row->co2 ) { ?>
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_SPECS_CO2;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->co2;?> <?php echo _EZAUTOS_VLDET_CO2EMM;?></td>
									</tr>
									<?php } ?>

									<?php if ( $row->numowners ) { ?>
									<tr>
										<td align="left">&nbsp;<strong><?php echo _EZAUTOS_SPECS_NUMOWNERS;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->numowners;?></td>
									</tr>
									<?php } ?>

				<?php if ( $row->rego ) { ?>
				<tr>
					<td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_REG;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->rego;?></td>
				</tr>
				<?php } ?>
				<?php if ( $row->vin ) { ?>
				<tr>
					<td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_VIN;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->vin;?></td>
				</tr>
				<?php } ?>
			</table>
		</td>
		<td valign="top" width="40%">
			<table border="0" width="100%" cellspacing="3" cellpadding="3">
				<tr>
					<td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_ADDNUM; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->id;?></td>
				</tr>
<?php if ( $ea_structure == 1 ) { ?>
				<tr>
					<td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_CATG; ?>&nbsp;:</strong>&nbsp;&nbsp;<a href="<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;Itemid=$myItemid&amp;task=viewcategory&amp;id=$row->cid");?>"><?php echo $row->category;?></a></td>
				</tr>
<?php } else { ?>
				<tr>
					<td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_CATG; ?>&nbsp;:</strong>&nbsp;&nbsp;<a href="<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;Itemid=$myItemid&amp;task=results&amp;cid=$row->cid&amp;trans=&amp;tag=&amp;pcode=&amp;fuel=&amp;make=0&amp;model=0&amp;maxprice=&amp;minprice=&amp;direction=ASCPRICE&amp;limit=10&amp;limitstart=0");?>"><?php echo $row->category;?></a></td>
				</tr>
<?php } ?>
				<?php if ( $row->tag ) { ?>
				<tr>
					<td>&nbsp;<strong><?php echo _EZAUTOS_DET_CONDITION; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->tag;?></td>
				</tr>
				<?php } ?>
				<tr>
					<td>&nbsp;<strong><?php echo _EZAUTOS_DET_AVAILABILITY; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->availability;?></td>
				</tr>
				<?php if ( $row->stocknum ) { ?>
				<tr>
					<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_STOCKNUM;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->stocknum;?></td>
				</tr>
				<?php } ?>
<?php if ( $row->pdfinfo ) { ?>
...
<table border="0" width="100%" cellspacing="3" cellpadding="3">
								...
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_FUELSYS; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->fuelsystem;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->borestroke ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_BORESTROKE; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->borestroke;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->power ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_POWER; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->power;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->torque ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_TORQUE; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->torque;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->weightpower ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_WEIGHTPOWER; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->weightpower;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->frontbrakes ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_FRONTBRAKES; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->frontbrakes;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->rearbrakes ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_REARBRAKES; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->rearbrakes;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->wheeldims ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_WHEELDIMS;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->wheeldims;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->turncirc ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_TURNCIRC;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->turncirc;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->compressionratio ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_COMPRAT;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->compressionratio;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->tankcapacity ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_TANKCAP;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->tankcapacity;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->extlength ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_EXTLENGTH;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->extlength;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->extwidth ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_EXTWIDTH; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->extwidth;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->extheight ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_EXTHEIGHT; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->extheight;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->fronttrack ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_FRONTTRACK; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->fronttrack;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->reartrack ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_REARTRACK; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->reartrack;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->wheelbase ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_WHEELBASE; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->wheelbase;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->frontsus ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_FRONTSUS; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->frontsus;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->rearsus ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_REARSUS; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->rearsus;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->kerbweight ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_KERBWEIGHT;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->kerbweight;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->groundclear ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_GRCLEAR;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->groundclear;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->seatcap ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_SEATCAP;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->seatcap;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->cityfuel ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_CITYFUEL;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->cityfuel;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->highwayfuel ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_HWYFUEL;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->highwayfuel;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->towingcap ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_TOWCAP;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->towingcap;?></td>
								</tr>
								<?php } ?>
								<?php if ( $row->countryorigin ) { ?>
								<tr>
									<td>&nbsp;<strong><?php echo _EZAUTOS_SPECS_COUNTRYORIGIN;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->countryorigin;?></td>
								</tr>
								<?php } ?>
...
<?php if ( $row->airco ) { ?>
			<tr><td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_AIRCO; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->pwin ) { ?>
			<tr><td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_POWIN; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->psteer ) { ?>
			<tr><td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_POSTEER; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->cruise ) { ?>
			<tr><td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_CC; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->airbag ) { ?>
			<tr><td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_AIRBAGS; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->abs ) { ?>
			<tr><td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_ALBS; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->amfm ) { ?>
			<tr><td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_AMFM; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->cdp ) { ?>
			<tr><td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_CDP; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->atheft ) { ?>
			<tr><td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_ATS; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->tilt ) { ?>
			<tr><td>&nbsp;<strong><?php echo _EZAUTOS_VLDET_TS; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
</table>
</td>
...
<table border="0" width="100%" cellspacing="3" cellpadding="3">
<?php if ( $row->custom1a ) { ?>
			<tr><td>&nbsp;<strong><?php echo $row->custom1a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->custom2a ) { ?>
			<tr><td>&nbsp;<strong><?php echo $row->custom2a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->custom3a ) { ?>
			<tr><td>&nbsp;<strong><?php echo $row->custom3a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->custom4a ) { ?>
			<tr><td>&nbsp;<strong><?php echo $row->custom4a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->custom5a ) { ?>
			<tr><td>&nbsp;<strong><?php echo $row->custom5a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->custom6a ) { ?>
			<tr><td>&nbsp;<strong><?php echo $row->custom6a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
<?php } ?>
<?php if ( $row->custom7a ) { ?>
			<tr>
				<td>&nbsp;<strong><?php echo $row->custom7a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td>
			</tr>
<?php } ?>
<?php if ( $row->custom8a ) { ?>
			<tr>
				<td>&nbsp;<strong><?php echo $row->custom8a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td>
			</tr>
<?php } ?>
<?php if ( $row->custom9a ) { ?>
			<tr>
				<td>&nbsp;<strong><?php echo $row->custom9a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td>
			</tr>
<?php } ?>
<?php if ( $row->custom10a ) { ?>
			<tr>
				<td>&nbsp;<strong><?php echo $row->custom10a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td>
			</tr>
<?php } ?>
...
<!--START VISITOR LINKS SELECTION BOX-->			
 <tr> 
                      <td height="27"><table width="304" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><img src="/components/com_ezautos/images/orangecurveTop.gif" width="304" height="11"></td>
                          </tr>
                          <tr>
                            <td background="/components/com_ezautos/images/greySmaalBoxBGD.gif"><div align="center">
							<table width="100%">
								<tr>									
									 <td>&nbsp;&nbsp;&nbsp;<span ><font color="#FFCC00"><strong><?php echo _EZAUTOS_TOOLS;?></strong></font></span></td>
								</tr>
								<tr>
									<td>
										<div align="center">
...
&nbsp;</td>
                          ...
                          <tr>
                            <td><img src="/components/com_ezautos/images/greySmallBoxBottom.gif" width="304" height="11"></td>
                          </tr>
                        </table></td>
                    </tr>
...
<table width="304" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td background="/components/com_ezautos/images/greySmaalBoxBGD.gif">		<?php if ( $ea_useprofile ) { ?>

						<div align="center">
							<table width="100%">
								<tr>									
									 <td>&nbsp;&nbsp;&nbsp;<span ><font color="#FFCC00"><strong><?php echo _EZAUTOS_PROFILE_DSDET;?></strong></font></span></td>
								</tr>
