...
<!--BEGIN SURROUNDING POLLSTABLEBORDER BLOCK-->
...
<!--END SURROUNDING POLLSTABLEBORDER BLOCK-->
...
<!--START VEHICLE SUMMARY TABLE-->			

			<div align="center">
				<table width="100%">
					<tr>
						<td colspan="2" class='sectiontableheader' align="left"><?php echo _EZAUTOS_LISTINGS_SUMMARY;?></td>
					</tr>
					<tr>
						<td>
							<div align="center">
...
<!--START VEHICLE SPECS TABLE-->			
			...
			<div align="center">
				<table width="100%">
					<tr>
						<td class='sectiontableheader' align="left"><?php echo _EZAUTOS_LISTINGS_TECHNICAL;?></td>
					</tr>
					<tr>
						<td>
							<div align="center">
					...
					<tr>
						<td>
							<div align="center">
								<table border="0" width="90%">
									<tr>
										<td valign="top" align="left"><div align="left"><?php echo $row->features;?></div><br /></td>
									</tr>
								</table>
							</div>
						</td>
									...
									<tr>
										...
										<td width="50%" valign="top">
											<table border="0" width="100%">
												...
												<?php } ?>
												<?php if ( $row->custom7a ) { ?>
												<tr><td align="left"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo $row->custom7a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
												<?php } ?>
												<?php if ( $row->custom8a ) { ?>
												<tr><td align="left"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo $row->custom8a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
												<?php } ?>
												<?php if ( $row->custom9a ) { ?>
												<tr><td align="left"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo $row->custom9a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
												<?php } ?>
												<?php if ( $row->custom10a ) { ?>
												<tr><td align="left"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo $row->custom10a; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td></tr>
												<?php } ?>
											</table>
										</td>
									</tr>
