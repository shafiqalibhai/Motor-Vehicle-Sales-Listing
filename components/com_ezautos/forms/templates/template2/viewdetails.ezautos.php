...
<!--BEGIN MAKE/MODEL ETC AND SHORT DESCRIPTION-->			
			...
			<table border="0" width="100%">
				<tr>
					<td class="sectiontableheader"><?php echo $row->year.' '.$row->makename.' '.$row->modelname.' '.$row->derivative;?>ABC</td>
				</tr>
			</table>
					...
					<tr>
						<td>
							<div align="center">
								<table border="0" width="90%">
									<tr>
										<td valign="top" align="left"><?php echo $row->features;?><br /><br /></td>
									</tr>
								</table>
							</div>
						</td>
...
<!--START SELLER INFORMATION BLOCK-->			
						...
						<div align="center">
							<table width="100%">
								<tr>
									<td colspan='2' align="left" class='sectiontableheader'><?php echo _EZAUTOS_PROFILE_DSDET;?></td>
							  </tr>
