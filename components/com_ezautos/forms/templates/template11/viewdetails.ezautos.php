...
<table width="618"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="11"><img src="http://www.icodeserver.com/components/com_ezautos/images/greyTop.gif" width="618" height="11"></td>
  </tr>
  <tr>
    <td background="http://www.icodeserver.com/components/com_ezautos/images/greyBoxBgd.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="11" bgcolor="666666"><table width="100%"  border="0" cellspacing="4" cellpadding="0">
            <tr>
              <td><span class="style1"><?php echo $row->year.' '.$row->makename.' '.$row->modelname.' '.$row->derivative;?></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
...
?></div></td>
  ...
  <tr>
    <td height="11"><img src="http://www.icodeserver.com/components/com_ezautos/images/greyBoxBottom.gif" width="618" height="11"></td>
  </tr>
</table><!--END IMAGE TABLE--></td>
	</tr>
	<tr>
	  <td valign="top">&nbsp;</td>
  </tr>
...
<!--START VEHICLE SPECS TABLE-->		  <!--END VEHICLE SPECS TABLE-->			


	                  <div align="left">
	                    <table width="618"  border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="618" height="11"><img src="http://www.icodeserver.com/components/com_ezautos/images/greyTop.gif" width="618" height="11"></td>
                          </tr>
                          <tr>
                            <td background="http://www.icodeserver.com/components/com_ezautos/images/greyBoxBgd.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td height="11" bgcolor="666666"><table width="100%"  border="0" cellspacing="4" cellpadding="0">
                                      <tr>
                                        <td><div align="left"><span class="style1"><?php echo _EZAUTOS_LISTINGS_SUMMARY;?></span></div></td>
                                      </tr>
                                  </table></td>
                                </tr>
                                <tr>
                          ...
                          <tr>
                            <td background="http://www.icodeserver.com/components/com_ezautos/images/greyBoxBgd.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td height="11" bgcolor="666666"><table width="100%"  border="0" cellspacing="4" cellpadding="0">
                                      <tr>
                                        <td><div align="left"><span class="style1"><?php echo _EZAUTOS_LISTINGS_TECHNICAL;?></span></div></td>
                                      </tr>
                                  </table></td>
                                </tr>
                                <tr>
...
<?php if ($row->features) { ?>
				<div align="left"></div>				<table width="618"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="618" height="11"><img src="http://www.icodeserver.com/components/com_ezautos/images/greyTop.gif" width="618" height="11"></td>
                  </tr>
                  <tr>
                    <td background="http://www.icodeserver.com/components/com_ezautos/images/greyBoxBgd.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="11" bgcolor="666666"><div align="left">
                            <table width="100%"  border="0" cellspacing="4" cellpadding="0">
                              <tr>
                                <td><div align="left"><span class="style1"><?php echo _EZAUTOS_DET_ADDFEAT; ?></span></div></td>
                              </tr>
                            </table>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="100" valign="middle"><div align="center">
                            <table border="0" width="90%">
                              <tr>
                                <td valign="top" align="left"><?php echo $row->features;?><br />
                                    <br /></td>
                              </tr>
                            </table> 
                            </div></td>
			...
			<table width="100%">
				<tr>
					<td class="sectiontableheader" align="left"><?php echo _EZAUTOS_DET_ADDFEAT; ?></td>
				</tr>
				<tr>
					<td>
	<div align="center">
...
<?php if ( $row->airco ) { ?>
			<tr>
			  <td align="left"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo _EZAUTOS_VLDET_AIRCO; ?> : </strong><?php echo _EZAUTOS_DET_YES; ?></td>
			</tr>
<?php } ?>
<?php if ( $row->pwin ) { ?>
...
<!--END ADDITIONAL VEHICLE FEATURES TABLE-->				  </td>
				</tr>
...
<!--START VISITOR LINKS SELECTION BOX-->			
						...
						<div align="center">
							<table width="304"  border="0" align="left" cellpadding="0" cellspacing="0">
                              <tr>
                                <td height="11" valign="top"><img src="http://www.icodeserver.com/components/com_ezautos/images/greySmallBoxTop.gif" width="304" height="11"></td>
                              </tr>
                              <tr>
                                <td valign="top" bgcolor="#666666"><table width="100%"  border="0" cellspacing="4" cellpadding="0">
                                  <tr>
                                    <td><div align="left"><span class="style1"><?php echo _EZAUTOS_TOOLS; ?></span></div></td>
                                  </tr>
                                </table></td>
                              </tr>
                              <tr>
                                <td valign="top" background="http://www.icodeserver.com/components/com_ezautos/images/greySmaalBoxBGD.gif"><table width="100%">
                                  <tr>
                                    <td>
                                      <div align="center">
                                        <table border="0" width="100%">
						...
						<div align="center">
							<table width="304"  border="0" align="left" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                <td valign="top" bgcolor="#666666"><table width="100%"  border="0" cellspacing="4" cellpadding="0">
                                  <tr>
                                    <td><div align="left"><span class="style1"><?php echo _EZAUTOS_PROFILE_DSDET;?></span></div></td>
                                  </tr>
                                </table></td>
                              </tr>
                              <tr>
                                <td valign="top" background="http://www.icodeserver.com/components/com_ezautos/images/greySmaalBoxBGD.gif"><table width="100%">
                                  ...
                                  <tr>
                                    <td colspan='2'><br />
                                        <strong><?php echo _EZAUTOS_PROFACCESS_DENIED;?></strong></td>
                                  </tr>
                                  <?php } ?>
                                </table></td>
                              </tr>
