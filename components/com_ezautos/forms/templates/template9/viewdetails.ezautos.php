...
if (file_exists(IMAGES_PATH."/images4a.php")) {
  include(IMAGES_PATH."/images4a.php");
} else {
}

} else {

if (file_exists(IMAGES_PATH."/images4b.php")) {
  include(IMAGES_PATH."/images4b.php");
} else {
}
...
<br />
<span class="h3"><?php echo _EZAUTOS_TOOLS; ?></span>
...
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<a href="javascript:void(0)" onclick="window.open('<?php echo $link1; ?>','win2','<?php echo $status1; ?>');" title="<?php echo _EZAUTOS_DET_PRINT;?>"><?php echo _EZAUTOS_DET_PRINT; ?></a><br />
<?php if ( $ea_useprofile==0 && $ea_viewenq ){ ?>
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<a href="javascript:void(0)" onclick="window.open('<?php echo $link2; ?>','win2','<?php echo $status2; ?>');" title="<?php echo _EZAUTOS_DET_ENQUIRE;?>"><?php echo _EZAUTOS_DET_ENQUIRE; ?></a><br />
<?php } if ( $ea_viewrecommend ){ ?>
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<a href="javascript:void(0)" onclick="window.open('<?php echo $link3; ?>','win2','<?php echo $status2; ?>');" title="<?php echo _EZAUTOS_DET_FRIEND;?>"><?php echo _EZAUTOS_DET_FRIEND; ?></a><br />
<?php } if ( $ea_viewmailing ){ ?>
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<a href="javascript:void(0)" onclick="window.open('<?php echo $link4; ?>','win2','<?php echo $status2; ?>');" title="<?php echo _EZAUTOS_DET_MLIST;?>"><?php echo _EZAUTOS_DET_MLIST; ?></a><br />
<?php } ?>
...
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<a href="<?php echo $mosConfig_live_site. '/index.php?option=com_ezautos&amp;task=detail&amp;id='. $id.'&amp;Itemid='.$myItemid;?>" onmousedown="addBookmark('<?php echo stripslashes( $ea_bizname );?>','<?php echo $mosConfig_live_site. '/index.php?option=com_ezautos&amp;task=detail&amp;id='. $id.'&amp;Itemid='.$myItemid;?>')" onmouseover="return overlib('<?php echo _EZAUTOS_BOOKMARK;?>')" onmouseout="return nd();"><?php echo _EZAUTOS_BOOKMARK;?></a><br />
<?php if ( $ea_shortlist ) { ?>
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<a href="javascript:void(0)" onclick="window.open('<?php echo $link7; ?>','win2','<?php echo $status3; ?>');" title="<?php echo _EZAUTOS_LISTINGS_ADDLIGHTBOX;?>"><?php echo _EZAUTOS_LISTINGS_ADDLIGHTBOX;?></a><br />
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<a href="<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;Itemid=$myItemid&amp;task=viewlightbox");?>"><?php echo _EZAUTOS_VIEW_LIGHTBOX;?></a><br />
<?php } ?>
...
<?php if ( $ea_usemap && $row->dealer_declat && $row->dealer_declong ){ ?>
...
<?php } ?>
		...
		<table border="0" width="100%">
			<tr>
				<td class="h3"><?php echo _EZAUTOS_VEHICLE_INFO;?><br /><hr /></td>
			</tr>
			<tr>
				<td valign="top">
...
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo _EZAUTOS_DET_PRICE; ?>&nbsp;:</strong>&nbsp;&nbsp;
<?php
...
<?php if ( $row->rego ) { ?>
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo _EZAUTOS_VLDET_REG;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->rego;?><br />
<?php } ?>
<?php if ( $row->vin ) { ?>
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo _EZAUTOS_VLDET_VIN;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->vin;?><br />
<?php } ?>
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo _EZAUTOS_VLDET_ADDNUM; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->id;?><br />
<?php if ( $ea_structure == 1 ) { ?>
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo _EZAUTOS_VLDET_CATG; ?>&nbsp;:</strong>&nbsp;&nbsp;<a href="<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;Itemid=$myItemid&amp;task=viewcategory&amp;id=$row->cid");?>"><?php echo $row->category;?></a><br />
<?php } else { ?>
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo _EZAUTOS_VLDET_CATG; ?>&nbsp;:</strong>&nbsp;&nbsp;<a href="<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;Itemid=$myItemid&amp;task=results&amp;cid=$row->cid&amp;trans=&amp;tag=&amp;pcode=&amp;fuel=&amp;make=0&amp;model=0&amp;maxprice=&amp;minprice=&amp;direction=ASCPRICE&amp;limit=10&amp;limitstart=0");?>"><?php echo $row->category;?></a><br />
<?php } ?>
<?php if ( $row->tag ) { ?>
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo _EZAUTOS_DET_CONDITION; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->tag;?><br />
<?php } ?>
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo _EZAUTOS_DET_AVAILABILITY; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->availability;?><br />
<?php if ( $row->stocknum ) { ?>
<img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo _EZAUTOS_SPECS_STOCKNUM;?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->stocknum;?><br />
<?php } ?>
	...
	<div align="center">
		<table border="0" width="100%">
								...
								<?php } ?>
									...
									<tr>
										<td align="left"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<strong><?php echo _EZAUTOS_DET_MILEAGE; ?>&nbsp;:</strong>&nbsp;&nbsp;<?php echo $row->odometer;?>&nbsp;
									</tr>
									<?php } ?>
...
<?php if ( $row->video != "http://" && $ea_useflv==1 && $row->video) { ?>
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="0" class="sectiontableentry1" style="border: outset 1px; cursor: hand;" onclick="toggleTab('video');" >
		<tr> 
			<td>
			<table border="0" cellspacing="0" cellpadding="1" style="font: 10pt Tahoma;">
					<tr valign="middle"> 
						<td><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/arrow_down.png" border="0" width="10" height="10" hspace="5" alt="" /></td>
						<td><strong>&nbsp;<?php echo _EZAUTOS_VIDEO; ?>&nbsp;</strong></td>
						<td><font size='1'>(<?php echo _EZAUTOS_LISTINGS_EXPAND;?>)</font></td>
					</tr>
				</table>
			</td>
	...
	<div id="video" style="padding: 10px; display: none;"> 
