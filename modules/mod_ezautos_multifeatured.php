...
<a href="<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;task=detail&amp;id=$row->id&amp;Itemid=$myItemid");?>"><strong><?php echo $row->year.' '.$row->makename.' '.$row->modelname.' '.$row->derivative;?></strong></a><br /><br />
  ...
  <?php } ?>
  </a> <?php echo $row->smalldesc;?> <a class="readon" href="<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;task=detail&amp;id=$row->id&amp;Itemid=$myItemid");?>"><?php echo _MOD_EZAUTOS_MFREADMORE;?></a><br /> 
  <br />
<td valign="top" width="<?php echo $colwidth;?>" align="left">&nbsp;</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top" width="26%" align="left"><?php if ($row->image1) { ?><a href="components/com_ezautos/<?php echo $ea_imagedirectory;?>/<?php echo $row->image1;?>" rel="lightbox" title="<?php echo $row->year.' '.$row->makename.' '.$row->modelname.' '.$row->derivative;?>"><?php } ?><?php if ($row->image1) { ?>
