...
<td valign="top" width="40%">
  ...
  <td width="10"><img src="<?php echo $mosConfig_live_site;?>/components/com_ezautos/images/pixel.gif" width="10" alt="" /></td>
    ...
    <td valign="top" width="<?php echo $colwidth;?>" align="left"> <table width="148" border="0" align="right" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td height="8" valign="top"><img src="/components/com_ezautos/images/blueTop.gif" width="192" height="14"></td>
        </tr>
        <tr> 
          <td height="160" valign="top" background="/components/com_ezautos/images/blueBGD.gif"> 
            <table width="100%" border="0" cellspacing="4" cellpadding="0">
              <tr> 
                <td><div align="center"><a href="<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;task=detail&amp;id=$row->id&amp;Itemid=$myItemid");?>"><font color="#fdf667" size="2"><strong><?php echo $row->year.' '.$row->makename.' '.$row->modelname.' '.$row->derivative;?></strong></font></a></div></td>
              </tr>
              <tr> 
                <td height="65" bgcolor="6a6a6a"><div align="center"><a href='<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;task=detail&amp;id=$row->id&amp;Itemid=$myItemid");?>'> 
                    <?php if ($row->image1) { ?>
              ...
              <tr> 
                <td><strong>
                  <div align="center"><font color="#999999"><?php echo $row->smalldesc;?></font>&nbsp;&nbsp;&nbsp;<a href="<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;task=detail&amp;id=$row->id&amp;Itemid=$myItemid");?>"><?php echo _MOD_EZAUTOS_MFREADMORE;?></strong>                    <br>
