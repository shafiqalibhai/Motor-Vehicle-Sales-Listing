...
<td valign="top" width="<?php echo $colwidth;?>" align="left"><br />
  <a href="<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;task=detail&amp;id=$row->id&amp;Itemid=$myItemid");?>"><strong><?php echo $row->year.' '.$row->makename.' '.$row->modelname.' '.$row->derivative;?></strong></a>ABC<br />
  <br />
