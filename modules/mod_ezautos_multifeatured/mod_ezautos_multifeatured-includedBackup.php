        ...
        <tr> 
          <td height="160" valign="top" background="/components/com_ezautos/images/blueBGD.gif"> 
            <table width="100%" border="0" cellspacing="4" cellpadding="0">
              <tr> 
                <td><a href="<?php echo sefRelToAbs("index.php?option=com_ezautos&amp;task=detail&amp;id=$row->id&amp;Itemid=$myItemid");?>"><font color="#fdf667" size="2"><strong><?php echo $row->year.' '.$row->makename.' '.$row->modelname.' '.$row->derivative;?></strong></font></a></td>
              </tr>
              <tr> 
