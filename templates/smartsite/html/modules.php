 ...
 * Module chrome for rendering the module in a slider
 */
function modChrome_smartsite($module, &$params, &$attribs) // modified for smartsite
{

	jimport('joomla.html.pane');
	// Initialize variables
	//$smartsite = & JPane::getInstance('smartsite');
	$smartsite = new JPaneSmartsite ();
	echo $smartsite->startPanel( JText::_( $module->title ), $module->id_smartsite_module > 0 ? $module->id_smartsite_module : $module->id );
	echo $module->content;
